export default [
    ...
    },
    {
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/essAuthRole/index.vue"
            ], resolve)
    },
    {
    ...
    },
    {
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoBusinessUserMange/autoBusinessUserMange"
            ], resolve)
    }, {
    ...
    },
    {
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoMyOrgBusiarea/autoOrgBusiarea"
            ], resolve)
    },
    {
        ...
        path: "autoPaysAcctype",
        name: "autoPaysAcctype",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoPaysAcctype/autoPaysAcctype"
            ], resolve)
    },
    {
        path: "autoPaySalacalc",
        name: "autoPaySalacalc",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoPaySalacalc/autoPaySalacalc"
            ], resolve)
    },
    {
        path: "autoShouldcalculated",
        name: "autoShouldcalculated",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoShouldcalculated/autoShouldcalculated"
            ], resolve)
    },
    {
        path: "autoMyOrgBusimod",
        name: "autoMyOrgBusimod",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoMyOrgBusimod/autoMyOrgBusimod"
            ], resolve)
    },
    {
        path: "autoMonthattCalendar",
        name: "autoMonthattCalendar",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoMonthattCalendar/autoMonthattCalendar"
            ], resolve)
    },
    {
        path: "autoPayMoncon",
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoPayMoncon/autoPayMoncon"
            ], resolve)
    },
    {
        path: "autoMyteam",
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoMyResum/autoMyresume"
            ], resolve)
    },
    {
        path: "autoPayBankoff",
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoPayBankoff/autoPayBankoff"
            ], resolve)
    },
    {
        path: "autoEmpRecord",
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoEmpRecord/autoEmpRecord"
            ], resolve)
    },
    {
        path: "autoOrgPostrelease",
        name: "autoOrgPostrelease",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoOrgPostrelease/autoOrgPostrelease"
            ], resolve)
    },
    {
        path: "autoOrgPostrelease1",
        name: "autoOrgPostrelease1",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoOrgPostrelease/autoOrgPostrelease1"
            ], resolve)
    },
    {
        path: "autoJobActivities",
        name: "autoJobActivities",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoJobActivities/autoJobActivities"
            ], resolve)
    },
    {
        path: "autoJobActivities1",
        name: "autoJobActivities1",
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoJobActivities/autoJobActivities1"
            ], resolve)
    },
    {
        path: "autoLabelStaff",
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autoLabelStaff/autoLabelStaff"
            ], resolve)
    },
    {
        path: "autosalaryPass",
        ...
        component: resolve =>
            require([
                "@/pagesZnjs/autoPage/autosalaryPass/autosalaryPass"
            ], resolve)
    },
];
