 ...
 * @Description: 
 * @Author: Gaoxueliang
 * @Date: 2020-08-11 17:34:19
 * @LastEditTime: 2020-08-18 15:36:19
 * @LastEditors: Sok
-->
<template>
  <div class="background">
    <div class="backbox">
      ...
      <Row class="table-form">
        ...
        <span style="margin: 0;"><Button style="width:56px" type="info" :loading="isSpin" @click="getData(id)"><span v-if="!isSpin">{{$t('button.ser')}}</span></Button></span>
