  ...
  <div class="background">
    <div class="backbox">
      ...
      <Tabs value="name1" @on-click="changeTab" ref="tab" type="card">
        ...
        <TabPane :label="$t('lang_role.adminuser.assignorg')"  name="name1">
          <Row>
            ...
            <Spin fix v-if="isSpin" size="large"></Spin>
              ...
              <Tree :data="dataTrees" show-checkbox multiple ref="tree"></Tree>
            </Col>
            <Col span="4" offset="1">
            <div class="btn-group">
...
//          item.checked = item.authRoleFunDis === '1'
          item.title = item.unitFnameCn+' - '+item.unitEmpIdDis
