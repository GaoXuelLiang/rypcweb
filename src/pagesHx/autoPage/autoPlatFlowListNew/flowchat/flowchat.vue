...
<script>
  ...
  import updFlowStep from '../../../../pages/platformmanager/platFlowStep/updFlowStep.vue'
  import updFlsRelation from '../../../../pages/platformmanager/platFlowStep/updFlsRelation'
