...
<!--          </div>-->
    ...
    <updFlowStep v-show="showStep" @closeUp="closeNode" :roleType="true" @editNodeFlowChart="editNodeFlowChart"
...
<script>
  ...
  import updFlowStep from '../../platFlowStepView/updFlowStep.vue'
  import updFlsRelation from '../../platFlowStepView/updFlsRelation'
...
//          console.log(obj)
      ...
      addNode(dataSource) {
        ...
        data.saveType = '1'
        data.id = t.lineId
        let type = data.nodeClass
        if (type === 'start' || type === 'end') {
          return
        }
        this.$refs.flowStep.setMainId(data.id)
        this.showStep = true
      },
      addLine(dataSource, controlPoints) {
        ...
        data.logType = '新增线'
        data.id = t.lineId
        this.$refs.flowLine.setLineId(data.id)
        this.showLine = true
      },
