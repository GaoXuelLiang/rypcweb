<!--
 * @Author: your name
 * @Date: 2020-09-14 13:36:58
 * @LastEditTime: 2020-11-06 22:07:47
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \hxpcweb\src\pagesHx\autoPage\autoMyOrgBusiarea\autoOrgBusiareaChild.vue
-->
<template>
  <div>
    <autoChildTable
