    ...
    <div class="box">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;{{$t('lang_organization.orgChart.title')}}
        </div>
      ...
      <div>
        ...
        <Button type="primary" @click="setUnitCharger" >{{charger}}</Button>
      </div>
      <div class="option-main">
        <Row style="max-height: 500px;overflow-y: auto;position: relative">
          ...
          <div v-if="!loading" class="text-center" style="height: 470px">
              <orgTree class="tree"
                       :data="data"
    ...
    methods: {
      getData(id) {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'OrgUnits.getUnitsChart',
          id: id,
