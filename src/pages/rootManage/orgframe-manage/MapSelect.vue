    ...
    <div class="box">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon> 选择公司地点
        </div>
        <Button type="text" @click="closeMap">
          <Icon type="md-close" size="20"></Icon>
        </Button>
      </div>

      <div class="option-main">
        <div id="isShowMap"  class="map">
          <!--<div class="title-text">-->
          ...
          <div class="search-wrapper">
            ...
            <ul class="search-list" v-show='searchResult.length'>
              <li v-for="item in searchResult" @click="selectAddress(item)" class="text-ellipsis">
