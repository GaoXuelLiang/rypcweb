        ...
        <Row>
            ...
            <card>
                ...
                <Row>
                    ...
                    <Row>
                        <span class="btn">
                            <Input placeholder="请输入职务级别"
                                   style="width: 200px"
                                   v-model="form.positionLevel" />
                        </span>
                        <!-- <span><Button type="info" :loading="isSpin"  @click="search()">{{$t('button.ser')}}</Button></span> -->
                        <!-- <Button class="btn" v-if="AccessControl.toString().includes('button_add')" type="warning" @click="openUp(NaN,$t('button.add'))">{{$t('button.add')}}</Button>
...
export default {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        ...
                        // 		style: {
                        // 			marginLeft: '5px',
                        // 			display: params.row.dutyStatus !== '01draft' ? 'none' : 'inline',
                        // 		},
                        // 		on: {
                        // 			click: () => {
    ...
    methods: {
        ...
        getData (page, value) {
            ...
            const data = {
                _mt:  this.$global.mt+'OrgPostlevelmapping.getPage',
                funId: t.funId,
                ...
                sort: t.sort,
                order: t.order,
                positionLevel: t.form.positionLevel,
            }
            if (value) {
                ...
                t.$Modal.confirm({
                    ...
                    onOk: () => {
                        getDataLevelUserLogin({
                            _mt:  this.$global.mt+'OrgPostlevelmapping.delByIds',
                            funId: '1',
