  ...
  <div class="background">
    <div class="backbox">
      ...
      <Row class="table-form">
        <Input placeholder="请输入公司编码" style="width: 150px" v-model="pmtypeCode"/>
      ...
      <row class="table-form" ref="table-form">
        ...
        <Table height="320" size="small"  ref="selection" style="background:transparent" :columns="searchCloumns" @on-sort-change="sortable" :data="data" @on-row-dblclick="dbCkick"></Table>
      </row>
