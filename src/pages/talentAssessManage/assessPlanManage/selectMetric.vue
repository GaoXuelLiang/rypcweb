  ...
  export default {
    ...
    methods: {
      getData(id) {
        ...
        t.id = id;
        const data={
        	_mt:  this.$global.mt+'EvaluationIndex.getSelectValue',
...
//        })
      ...
      getSelectData(id) {
        const t = this
        const data={
        	_mt:  this.$global.mt+'EvaluationProinfo.getByPId',
        	logType: this.$t('button.ser'),
        	indType: '03eval',
        	pid: id,
        }
...
//        })
	...
	indexId = checkedId.join(',');
        const data = {
          _mt:  this.$global.mt+'EvaluationProinfo.saveEvaluateProinfo',
          logType: '选择指标',
          pid: t.id,
          indexIds: indexId,
        }
