    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;{{$t('lang_evaluation.evaluation.diagObject1')}}
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="$t('lang_evaluation.evaluation.resYear2Ins')" style="width: 200px" v-model="pmtypeCode"/>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      dbCkick(row) {
        const t = this
        this.$emit('changeinputDiag', row.id ,row.resEmpidDis)
        t.close()
      },
      sizeChange(size) {
        const t = this
