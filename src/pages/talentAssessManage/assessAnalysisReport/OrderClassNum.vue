...
<template>
  <div style="width: 100%;">
    <div id="OrderClassNum" ref="OrderClassNum" style="width: 100%;height: 350px;margin-top:52px"></div>
  </div>
</template>
<script>
      ...
      getData(id) {
       ...
       let resId=id
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EvaluationResult.analysisChart4',
          ...
          if (isSuccess(res, t)) {
            ...
            if(res.data.content[0].value!=''&&res.data.content[0].value!=undefined){
             ...
             if(value.indicator.length!=0&&value.value.length!=0){
