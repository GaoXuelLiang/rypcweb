      ...
      <Row class="content form_box">
        <Form ref="formValidate" disabled :model="formValidate" label-position="right" :label-width="135">
          <i-col span="10" offset="1">
            <FormItem class="marNT" :label="$t('lang_approval.wxcontract.apwxtoContact')" prop="apwxtoContactDis">
              <Input v-model="apwxtoContactDis" readonly placeholder=""></Input>
            </FormItem>
          </i-col>
          <i-col span="10" offset="1">
            <FormItem class="marNT" :label="$t('lang_approval.wxcontract.apwxtoIsvalid')" prop="apwxtoIsvalid">
