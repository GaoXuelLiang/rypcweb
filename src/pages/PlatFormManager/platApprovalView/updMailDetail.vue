      ...
      <Row class="content form_box">
        <Form :model="form" disabled label-position="right" :rules="ruleValidate"  :label-width="135" ref="form">
          <i-col span="10" offset="1">
            <FormItem class="marNT" :label="$t('lang_approval.mailList.aprvmlOrder')" prop="aprvmlOrder">
          ...
          <i-col span="10" offset="1">
            <FormItem :label="$t('lang_approval.mailList.aprvmlIsencrypt')" prop="aprvmlIsencrypt">
              <RadioGroup  v-model="form.aprvmlIsencrypt" type="button" size="small">
          ...
          <i-col span="10"  offset="1">
            <FormItem :label="$t('lang_approval.mailList.aprvmlIsvalid')" prop="aprvmlIsvalid">
              <RadioGroup  v-model="form.aprvmlIsvalid" type="button" size="small">
                <Radio :label="item.paramCode" v-for="(item,index) in yesno" :key="index">{{item.paramInfoCn}}</Radio>
              </RadioGroup>
            </FormItem>
          </i-col>
          <i-col span="21" offset="1" v-show="form.aprvmlIsvalid === '0'? true:false">
        ...
        <i-col span="21" offset="1">
              <row type="flex" justify="end" class="treebtn" style="margin-top:20px;margin-right:7px;"> 
  ...
  export default {
    data() {
      return {
        ...
        yesno: [],
        form: {
          _mt:  this.$global.mt+'PlatAprvmail.addOrUpd',
          aprvmlOrder: '',
          aprvmlObject: '',
          aprvmlContent: '',
          aprvmlSendstyle: '',
    ...
    methods: {
      getFormData(id) {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'PlatAprvmail.getById',
          id: id,
