<template>
  <div class="content-main platMailAttrchild">
    <Row class="btnHeight">
  ...
  export default {
    data() {
      return {
        ...
        data: [],
        params: {
          _mt:  this.$global.mt+'PlatSysmailAttachment.getPage',
          rows: 10,
          page: 1,
          sort: 'id',
          order: 'desc',
          ...
          t.$Modal.confirm({
            ...
            onOk: () => {
              getDataLevelUserLogin({
                _mt:  this.$global.mt+'PlatSysmailAttachment.delByIds',
                funId: '1',
