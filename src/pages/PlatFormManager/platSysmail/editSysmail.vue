    ...
    <div class="option-main">
        <Row class="form_box">
            ...
            <Form :model="form"
                ...
                <Row>
                <i-col span="10">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailNo')"
                              prop="sysmailNo">
                        <Input v-model="form.sysmailNo"
                               :placeholder="$t('lang_platdoc.platMail.sysmailNoDis')"></Input>
                    </FormItem>
                </i-col>
                <i-col span="10"
                       offset="1">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailName')"
                              prop="sysmailName">
                        <Input v-model="form.sysmailName"
                               :placeholder="$t('lang_platdoc.platMail.sysmailNameDis')"></Input>
                    </FormItem>
                </i-col>
                </Row>
                <Row>
                <i-col span="21">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailObject')"
                              prop="sysmailObject">
                        <Input v-model="form.sysmailObject"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_platdoc.platMail.sysmailObjectDis')"></Input>
                    </FormItem>
                </i-col>
                </Row>
                <Row>
                <i-col span="10">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailTo')"
                              prop="sysmailTo">
                        <Input v-model="form.sysmailTo"
                               :placeholder="$t('lang_platdoc.platMail.sysmailToDis')"></Input>
                    </FormItem>
                </i-col>
                <i-col span="10"
                       offset="1">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailCc')"
                              prop="sysmailCc">
                        <Input v-model="form.sysmailCc"
                               :placeholder="$t('lang_platdoc.platMail.sysmailCcDis')"></Input>
                    </FormItem>
                </i-col>
                </Row>
                <i-col span="21">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailContent')"
                              prop="sysmailContent">
                        <div id="editor"></div>
                ...
                <Row>
                <i-col span="10">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailSendcondition')"
                              prop="sysmailSendcondition">
                        <Input v-model="form.sysmailSendcondition"
                               :placeholder="$t('lang_platdoc.platMail.sysmailSendconditionDis')"></Input>
                    </FormItem>
                </i-col>
                <i-col span="10"
                       offset="1">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailIsencrypt')"
                              prop="sysmailIsencrypt">
                        <RadioGroup v-model="form.sysmailIsencrypt" type="button" size="small"
                                    :placeholder="$t('lang_platdoc.platMail.sysmailIsencryptDis')">
                ...
                <Row>
                <i-col span="10">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailFlow')"
                              prop="sysmailFlow">
                        <span @dblclick="dbClear">
                            <Input v-model="sysmailFlowDis"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_platdoc.platMail.sysmailFlowDis')"
                                   @on-click="getFlowId" />
                        </span>
                    </FormItem>
                </i-col>
                <i-col span="10"
                       offset="1">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailFlowstep')"
                              prop="sysmailFlowstep">
                        <span @dblclick="dbClear2">
                            <Input v-model="sysmailFlowstepDis"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_platdoc.platMail.sysmailFlowstepDis')"
                                   @on-click="getFlowstepId" />
                        </span>
                ...
                <i-col span="10">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailIsvalid')"
                              prop="sysmailIsvalid">
                        <RadioGroup v-model="form.sysmailIsvalid" type="button" size="small"
                                    :placeholder="$t('lang_platdoc.platMail.sysmailIsvalidDis')">
                            <Radio :label="item.paramCode"
                                   v-for="(item,index) in radioYesOrNo"
                                   :key="index">{{item.paramInfoCn}}</Radio>
                        </RadioGroup>
                ...
                <i-col span="21">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailInvreason')"
                              prop="sysmailInvreason">
                        <Input v-model="form.sysmailInvreason"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_platdoc.platMail.sysmailInvreasonDis')"></Input>
                    </FormItem>
                </i-col>
                <i-col span="21">
                    <FormItem :label="$t('lang_platdoc.platMail.sysmailComment')"
                              prop="sysmailComment" style="margin-bottom:0 !important">
                        <Input v-model="form.sysmailComment"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_platdoc.platMail.sysmailCommentDis')"></Input>
                    </FormItem>
                </i-col>
            </Form>
                <i-col span="21"
        ...
        <transition name="fade">
            <searchTable2 v-show="openPick2"
                          :flstepFlowCop="flstepFlowCop"
                          @closeUp="close2"
                          @changeinput="changeinput2"
                          ref="searchTable2"></searchTable2>
        </transition>
        <!-- <Row style="margin-top:20px;padding-right:10px">
            <i-col span="21">
...
export default {
    data () {
        ...
        return {
            ...
            openPick: false,
            form: {
                _mt:  this.$global.mt+'PlatSysmail.addOrUpd',
                sysmailNo: '',
                sysmailName: '',
                sysmailObject: '',
                sysmailTo: '',
    ...
    methods: {
        getdata () {
            ...
            t.spinShow = true;
            const params = {
                _mt:  this.$global.mt+'PlatSysmail.getById',
