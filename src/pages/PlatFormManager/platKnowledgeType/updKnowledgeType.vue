    ...
    <div class="cover">
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    <Col span="11">
                    <FormItem label="知识库类型编码"
                              prop="platKntypeCode">
                        <Input v-model="formValidate.platKntypeCode"
                               placeholder="请输入知识库类型编码"></Input>
                    </FormItem>
                    </Col>
                    <Col span="11"
                         offset="1">
                    <FormItem label="知识库类型名称"
                              prop="platKntypeName">
                        <Input v-model="formValidate.platKntypeName"
                               placeholder="请输入知识库类型名称"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="11">
                    <FormItem label="所属知识库类型"
                              prop="platKntypePid">
                        <span @dblclick="clear">
                            <Input v-model="platKntypePidDis"
                                   icon="ios-search"
                                   :readonly="true"
                                   placeholder="请选择所属知识库类型"
                                   @on-click="pickData" />
                        </span>
                    </FormItem>
                    </Col>
...
export default {
    data () {
        return {
            ...
            platKntypePidDis: '',
            formValidate: {
                _mt:  this.$global.mt+'PlatKnlType.addOrUpd',
                platKntypeCode: '',
                platKntypeName: '',
                platKntypePid: '',
                comment: '',
    ...
    methods: {
        getData (id) {
            ...
            getDataLevelUserLogin({
                _mt:  this.$global.mt+'PlatKnlType.getById',
                id: id,
                funId: '1',
                logType: this.$t('button.ser'),
            }).then((res) => {
