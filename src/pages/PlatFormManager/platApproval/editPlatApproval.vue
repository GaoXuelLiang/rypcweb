        ...
        <Row class="form_box">
            <Form ref="formValidate"
                ...
                <i-col span="10" offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvCode')"
                              prop="aprvCode">
                        <Input v-model="formValidate.aprvCode"
                               :disabled="editDisbale"
                               :placeholder="$t('lang_approval.platapprovallist.aprvCodeDis')"></Input>
                    </FormItem>
                </i-col>
                <i-col span="10"
                       offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvName')"
                              prop="aprvName">
                        <Input v-model="formValidate.aprvName"
                               :disabled="editDisbale"
                               :placeholder="$t('lang_approval.platapprovallist.aprvNameDis')"></Input>
                    </FormItem>
                </i-col>
                </row>
                <row>
                <i-col span="10" offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvStatus')"
                              prop="aprvStatus">
                        <Select v-model="aprvStatus"
                                :disabled="editDisbale"
                                :placeholder="$t('lang_approval.platapprovallist.aprvStatusDis')"
                                transfer>
                            <Option :value="item.paramCode"
                                    v-for="(item,index) in selectAprvStatus"
                ...
                <i-col span="10"
                       offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvFormtype')"
                              prop="aprvFormtype">
                        <Select v-model="formValidate.aprvFormtype"
                                :disabled="editDisbale">
                            <Option :value="item.paramCode"
                ...
                <row>
                <i-col span="10" offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvForm')"
                              prop="aprvForm">
                        <span @dblclick="clear1">
                            <Input v-model="aprvFormDis"
                                   :disabled="editDisbale"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_approval.platapprovallist.aprvFormDis')"
                                   @on-click="pickData" />
                        </span>
                    </FormItem>
                </i-col>
                <i-col span="10"
                       offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvVersion')"
                              prop="aprvVersion">
                        <Input v-model="formValidate.aprvVersion"
                               :disabled="editDisbale"
                               :placeholder="$t('lang_approval.platapprovallist.aprvVersionDis')"></Input>
                    </FormItem>
                </i-col>
                </row>
                <i-col span="21" offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvAfthd')"
                              prop="aprvAfthdclass">
                        <Input v-model="formValidate.aprvAfthdclass"
                               :disabled="editDisbale"
                               :placeholder="$t('lang_approval.platapprovallist.aprvAfthdDis')"></Input>
                    </FormItem>
                </i-col>
                <i-col span="21" offset="1">
                    <FormItem :label="$t('lang_approval.platapprovallist.aprvComment')"
                              prop="aprvComment">
                        <Input v-model="formValidate.aprvComment"
                               :disabled="editDisbale"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_approval.platapprovallist.aprvCommentDis')"></Input>
                    </FormItem>
                </i-col>
            </Form>
            <i-col span="21" offset="1">
            ...
            <Row>
                <!-- <i-col span="21"  offset="1"
                       class="btn">
                    <Button v-show="!editDisbale" @click="handleReset">{{$t('button.cal')}}</Button>
                    <Button type="primary"
                            v-show="!editDisbale"
...
export default {
    data () {
        return {
            ...
            aprvStatus: '01draft',
            formValidate: {
                _mt:  this.$global.mt+'PlatApproval.addOrUpd',
                aprvCode: '',
                aprvName: '',
                aprvStatus: '',
                aprvFormtype: '',
    ...
    methods: {
        getData () {
            ...
            getDataLevelUserLogin({
                _mt:  this.$global.mt+'PlatApproval.getById',
        ...
        handleSubmit () {
            const t = this
            t.formValidate.aprvStatus = t.aprvStatus
