        ...
        <Form :model="form" label-position="right" :rules="ruleValidate"  :label-width="135" ref="form">
          ...
          <i-col span="10" offset="1">
            <FormItem :label="$t('lang_approval.wxList.aprvwxIsvalid')" prop="aprvwxIsvalid">
              <RadioGroup  v-model="form.aprvwxIsvalid" type="button" size="small">
          ...
          <i-col span="21" offset="1" v-show="form.aprvwxIsvalid === '0'?true:false">
  ...
  export default {
    data() {
      return {
        ...
        wxmsgtype: [],
        form: {
          _mt:  this.$global.mt+'PlatAprvwx.addOrUpd',
          aprvwxOrder: '',
          aprvwxContent: '',
          aprvwxSendstyle: '',
          aprvwxIsvalid: '1',
    ...
    methods: {
      getFormData(id) {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'PlatAprvwx.getById',
          id: id,
