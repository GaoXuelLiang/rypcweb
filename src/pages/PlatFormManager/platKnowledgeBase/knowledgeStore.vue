        ...
        <Row>
          ...
          <Row>
            <Input style="width: 300px;" size="large" v-model="keyWords" placeholder="请输入知识库关键字..." >
		        	<Button slot="append"  @click="searchKnowledge"></Button>
		    		</Input>
          </Row>
  ...
  export default{
    ...
    methods: {
    	getAllData() {
    		const t = this
				const data = {
          _mt:  this.$global.mt+'PlatKnowledge.getList',
         	funId: 1,
        ...
        const data = {
          _mt:  this.$global.mt+'PlatKnowledge.getObject',
         	funId: 1,
          logType: this.$t('button.ser'),
          sort: 'id',
        	order: 'desc',
        ...
        const t = this
        const data = {
          _mt:  this.$global.mt+'PlatKnlType.getMainTypeTree',
          funId: 1,
          logType: this.$t('button.ser'),
          id: '0',
        }
...
//      console.log(t.$refs.tree)
      ...
      searchKnowledge() {
      	const t = this
      	const data = {
          _mt:  this.$global.mt+'PlatKnowledge.getByKeyWords',
         	funId: 1,
          logType: this.$t('button.ser'),
          sort: 'id',
        	order: 'desc',
