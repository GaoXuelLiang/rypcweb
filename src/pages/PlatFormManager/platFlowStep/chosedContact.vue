        ...
        <div class="backbox">
            ...
            <div class="table-form">
                <Row>
                    <Button type="warning"
                            @click="addConList"
                            class="btnStyle">{{$t('button.add')}}</Button>
                    <Button type="error"
                            @click="deletemsg"
                            class="btnStyle">{{$t('button.del')}}</Button>
                </Row>
            </div>
            <row class="table-form"
                ...
                <Table stripe
                       ...
                       ref="selection"
                       :columns="columns"
                       :data="$store.state.flowStepData.childTable5"></Table>
            </row>
            ...
            <updChsCon v-show="showMsg"
                       @hideMsg="hideMsg"
                       ref="updChsCon"
                       :conttype="conttype"
                       :logType="logType"></updChsCon>
            <addConList v-show="showAddMsg"
                        @hideMsg="hideAddMsg"
                        ref="addConList"
                        :conttype="conttype"></addConList>
