        ...
        <div class="box">
            ...
            <Row class="content">
                <Form ref="formValidate"
                    ...
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mailCon.flsmlrContact')"
                                  prop="flsmlrContact">
                            <Input v-model="flsmlrContactDis"
                                   readonly
                                   placeholder=""></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mailCon.flsmlrIsvalid')"
                                  prop="flsmlrIsvalid">
                    ...
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mailCon.flsmlrConditionDis')"
                                  prop="flsmlrConditionDis">
                            <span @dblclick="clearCondition">
                                <Input v-model="formValidate.flsmlrConditionDis"
                                       type="textarea"
                                       readonly="readonly"
                                       :autosize="{minRows: 2,maxRows: 5}"
                                       :placeholder="$t('lang_flow.mailCon.p_flsmlrConditionDis')"
