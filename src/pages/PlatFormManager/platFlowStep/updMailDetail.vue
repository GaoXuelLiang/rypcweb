        ...
        <div class="box">
            ...
            <Row class="content form_box">
                <Form :model="form"
                    ...
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlOrder')"
                                  prop="flsmlOrder"
                                  class="marNT">
                            <Input v-model="form.flsmlOrder"
                                   :placeholder="$t('lang_flow.mail.p_flsmlOrder')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlReciever')"
                                  prop="flsmlReceper">
                            <Input v-model="form.flsmlReceper"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.mail.p_flsmlReciever')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlCC')"
                                  >
                            <Input v-model="form.flsmlCopyper"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.mail.p_flsmlCC')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlObject')"
                                  prop="flsmlObject">
                            <Input v-model="form.flsmlObject"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.mail.p_flsmlObject')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlContent')"
                                  prop="flsmlContent">
                            <div id="editorAdd"></div>
                            <div id="txt"
                                 v-model="form.flsmlContent"
                                 v-show="emailMes"></div>
                        </FormItem>
                    </i-col>
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlSendstyle')"
                                  prop="flsmlSendstyle">
                            <Select v-model="form.flsmlSendstyle"
                                    :placeholder="$t('lang_flow.mail.p_flsmlSendstyle')">
                    ...
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlSendconditionDis')"
                                  prop="flsmlSendconditionDis">
                            <span @dblclick="clearCondition">
                                <Input v-model="form.flsmlSendconditionDis"
                                       type="textarea"
                                       readonly="readonly"
                                       :autosize="{minRows: 2,maxRows: 5}"
                                       :placeholder="$t('lang_flow.mail.p_flsmlSendconditionDis')"
                    ...
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlIsencrypt')"
                                  prop="flsmlIsencrypt">
                    ...
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.flsmlIsvalid')"
                                  prop="flsmlIsvalid">
                    ...
                    <i-col span="21"
                           offset="1"
                           v-show="form.flsmlIsvalid ==='0'? true:false">
                        <FormItem :placeholder="$t('lang_flow.mail.flsmlInvreason')"
                                  prop="flsmlInvreason">
                            <Input v-model="form.flsmlInvreason"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.mail.p_flsmlInvreason')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.mail.comment')"
                                  prop="comment">
                            <Input v-model="form.comment"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.mail.p_comment')"></Input>
                        </FormItem>
                    </i-col>
                </Form>
                <i-col span="21"
    ...
    data () {
        return {
            ...
            ruleValidate: {
                ...
                flsmlReceper: [
                    { required: true, message: this.$t('lang_flow.mail.rule_flsmlReciever'), trigger: 'blur' },
                ],
                flsmlObject: [
        ...
        getFormData (id) {
            ...
            getDataLevelUserLoginData({
                ...
                if (isSuccess(res, t)) {
                    ...
                    t.form.flsmlReceper = res.data.content[0].flsmlReceper
                    t.form.flsmlCopyper = res.data.content[0].flsmlCopyper
