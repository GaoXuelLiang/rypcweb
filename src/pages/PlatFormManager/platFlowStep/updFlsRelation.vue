      ...
      <div class="option-main">
        <Row>
          <Form ref="formValidate" :model="formValidate" label-position="right" :label-width="135">
            ...
            <i-col span="21" offset="1">
              <FormItem label="条件">
                <Input v-model="formValidate.flsrelConditionDis"  type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请设置生成条件..." class="settlement"></Input>
              	<Button type="primary" @click="generConditionNow(NaN,'条件设置')">条件设置</Button>
              </FormItem>
            </i-col>
            <i-col span="21" offset="1">
              <FormItem label="流程步骤指向">
                <Select  clearable v-model="formValidate.flsrelRelatype"   placeholder="请选择连线关系">
            ...
            <i-col span="21" offset="1">
              <FormItem label="同级步骤关系">
                <Select  clearable v-model="formValidate.flsrelRelatypetype"   placeholder="请选择连线关系间的关系">
                  <Option :value="item.paramCode" v-for="(item,index) in select1" :key="index">{{item.paramInfoName}}</Option>
                </Select>
              </FormItem>
            </i-col>
            <i-col span="21" offset="1">
      ...
      * */
      ...
      getSelect() {
        ...
        getDataLevelUserLoginData({
          ...
          APtypeCode: 'FlowStepType,FlowStepTypeType',
        }).then((res) => {
          if (isSuccess(res, t)) {
