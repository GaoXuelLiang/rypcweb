        ...
        <div class="box">
            ...
            <Row class="content form_box">
                <Form :model="form"
                    ...
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxOrder')"
                                  prop="flwxOrder"
                                  class="marNT">
                            <Input v-model="form.flwxOrder"
                                   :placeholder="$t('lang_flow.weixin.p_flwxOrder')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxType')"
                                  prop="flwxType"
                                  class="marNT">
                            <Select v-model="form.flwxType">
                                <Option :value="item.paramCode"
                                        v-for="(item,index) in wxmsgtype"
                    ...
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxTitle')"
                                  v-if="form.flwxType === '02textcard'"
                                  prop="flwxTitle">
                            <Input v-model="form.flwxTitle"
                                   :placeholder="$t('lang_flow.weixin.p_flwxTitle')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxContent')"
                                  prop="flwxContent">
                            <Input v-model="form.flwxContent"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.weixin.p_flwxContent')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxLink')"
                                  v-if="form.flwxType === '02textcard'"
                                  prop="flwxLink">
                            <Input v-model="form.flwxLink"
                                   :placeholder="$t('lang_flow.weixin.p_flwxLink')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxSendstyle')"
                                  prop="flwxSendstyle">
                    ...
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxSendconditionDis')"
                                  prop="flwxSendconditionDis">
                            <span @dblclick="clearCondition">
                                <Input v-model="form.flwxSendconditionDis"
                                       type="textarea"
                                       readonly="readonly"
                                       :autosize="{minRows: 2,maxRows: 5}"
                                       :placeholder="$t('lang_flow.weixin.p_flwxSendconditionDis')"
                    ...
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.flwxIsvalid')"
                                  prop="flwxIsvalid">
                            <RadioGroup v-model="form.flwxIsvalid" type="button" size="small">
                    ...
                    <i-col span="21"
                           offset="1"
                           v-show="form.flwxIsvalid ==='0'?true:false">
                        <FormItem :label="$t('lang_flow.weixin.flwxInvreason')"
                                  prop="flwxInvreason">
                            <Input v-model="form.flwxInvreason"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.weixin.p_flwxInvreason')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.weixin.comment')"
                                  prop="comment">
                            <Input v-model="form.comment"
                                   type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}"
                                   :placeholder="$t('lang_flow.weixin.p_comment')"></Input>
                        </FormItem>
                    </i-col>
                </Form>
                <i-col span="21"
...
export default {
    data () {
        return {
            ...
            transmitValue: '',
            form: {
                _mt:  this.$global.mt+'PlatFlswx.addOrUpd',
                id: '',
                flwxOrder: '',
                flwxContent: '',
                flwxSendstyle: '',
    ...
    methods: {
        getFormData (id) {
            ...
            getDataLevelUserLoginData({
                _mt:  this.$global.mt+'PlatFlswx.getById',
                APid: id,
        ...
        getSelect () {
            ...
            getDataLevelUserLoginData({
                ...
                APtypeCode: 'yesno,sendtype,wxmsgtype',
            }).then((res) => {
                if (isSuccess(res, t)) {
