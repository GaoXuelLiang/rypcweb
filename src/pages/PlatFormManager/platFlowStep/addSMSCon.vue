<template>
  ...
  <div class="content-main">
    <row class="table-form" ref="table-form">
      <Table stripe :loading="loading" :no-data-text="noDataImg" @on-selection-change="selectedtable" @on-sort-change="sortable" height="320" size="small" ref="selection" :columns="columns" :data="data"></Table>
    </row>
     <row type="flex"
                             justify="end"
                             class="btn">
    ...
    <!-- <Row>
      <Button class="btn" @click="close">{{$t('button.cal')}}</Button>
  ...
  export default {
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_flow.SMSCon.contactMark'),
            key: 'contactMark',
            align: 'left',
          },
          {
            title: this.$t('lang_flow.SMSCon.contactName'),
            key: 'contactName',
            align: 'left',
          },
        ],
    ...
    methods: {
      ...
      save() {
        const t = this
        const data = {
          _mt:  this.$global.mt+'VMailContact.addSMSCon',
          APfunId: '1',
          APlogType: this.$t('button.ser'),
          id: t.tableselected,
