<template>
  ...
  <div class="content-main">
    <row class="table-form" ref="table-form">
      <Table stripe :loading="loading" :no-data-text="noDataImg" @on-selection-change="selectedtable" @on-sort-change="sortable" :height="420" size="small" ref="selection" :columns="columns" :data="data"></Table>
    </row>
    <row type="flex"
          justify="end"
          class="btn">
