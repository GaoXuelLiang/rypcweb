      ...
      <row>
        ...
        <i-col class="meau-right" span="19">
          ...
          <div class="menu_content">
            <fOption v-show="option" :logType="logType" ref="fOption" :id="id" @getid="getid" @update="update" @newdata="newdata" @close="handleReset"></fOption>
  ...
  export default {
    data() {
      return {
        ...
        id: NaN,
        data: {
          _mt:  this.$global.mt+'PlatAutotask.getById',
          funId: '1',
        },
      }
    },
