            ...
            <card>
                ...
                <div v-show="calendarModel1">
                    <Row class="btnHeight">
                        ...
                        <DatePicker class="sInput" v-model="year" @on-change="selectYear" type="year" :placeholder="$t('lang_platform.platCalendar.cYear')" style="width: 200px"></DatePicker>
                ...
                <div v-show="calendarModel2"
                    ...
                    <Row class="btnHeight">
                        <Button type="primary"
                                class="brn-mar"
                                @click="getCaldearData(1)">{{$t('lang_platform.platCalendar.lastM')}}</Button>
                        <!-- <Select v-model="year"
                                style="width: 200px"
                        ...
                        <DatePicker class="brn-mar" v-model="year" @on-change="selectYear" type="year" :placeholder="$t('lang_platform.platCalendar.cYear')" style="width: 200px"></DatePicker>
                        ...
                        <Button type="primary"
                                class="brn-mar"
                                @click="getCaldearData(2)">{{$t('lang_platform.platCalendar.nextM')}}</Button>
                        <Button type="warning"
                                class="brn-mar"
