        ...
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    ...
                    <FormItem label="发布时间"
                        ...
                        <DatePicker type="date"
                                    placeholder="请选择发布时间..."
                                    v-model="formValidate.platKldPublish"
                    ...
                    <FormItem label="失效时间">
                        <DatePicker type="date"
                                    placeholder="请选择失效时间..."
                                    v-model="formValidate.platKldLosttime"
                                    style="width: 100%"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <FormItem label="序号"
                              prop="platKldOrder">
                        <Input v-model="formValidate.platKldOrder"
                               placeholder="请输入序号..."></Input>
                    </FormItem>
                    </Col>
                    <Col span="11"
                         offset="1">
                    <FormItem label="知识库类型"
                              prop="platKldType">
                        <span @dblclick="clear">
                            <Input v-model="platKldTypeDis"
                                   icon="ios-search"
                                   :readonly="true"
                                   placeholder="请选择知识点上级标题"
                                   @on-click="pickData" />
                        </span>
                    </FormItem>
                    </Col>
                ...
                <Row>
                    <Col span="23">
                    <FormItem label="知识点标题"
                              prop="platKldTitle">
                        <Input v-model="formValidate.platKldTitle"
                               placeholder="请输入知识点标题..."></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row style="margin-right: 30px;">
                    ...
                    <FormItem label="内容"
                        ...
                        <div id="editor"></div>
                        <input id="txt"
                               v-model="formValidate.platKldContent"
                               v-show="editShow"></input>
                    </FormItem>
                    </col>
                </Row>
                <Row>
                ...
                <Row>
                    ...
                    <FormItem label="状态"
                              prop="platKldState">
                        <Select v-model="formValidate.platKldState"
                                placeholder="选择知识点状态"
                                transfer>
                            <Option :value="item.paramCode"
                                    v-for="(item,index) in knowledgeStatus"
                    ...
                    <Col span="11"
                         offset="1">
                    <FormItem label="是否控制权限"
                              prop="platKldAuth">
                        <RadioGroup v-model="formValidate.platKldAuth" type="button" size="small"
                                    placeholder="选择是否控制权限"
                                    transfer>
...
export default {
    data () {
        return {
            ...
            loadingStatus: false,
            formValidate: {
                _mt:  this.$global.mt+'PlatKnowledge.addOrUpd',
                platKldPublish: '',
                platKldLosttime: '',
                platKldType: '',
                platKldTitle: '',
            ...
            params: {
                _mt:  this.$global.mt+'PlatKnlType.getPage',
                sort: 'platKntypeCode',
                order: 'asc',
                rows: '10',
                page: '1',
    ...
    methods: {
        getData (id) {
            ...
            getDataLevelUserLogin({
                _mt:  this.$global.mt+'PlatKnowledge.getById',
                id: id,
                funId: '1',
                logType: this.$t('button.ser'),
            }).then((res) => {
