      ...
      <row>
        ...
        <i-col class="meau-right" span="19">
          ...
          <div class="menu_content">
            <addAndUpdPlatGetValDefine v-show="addAndUpdPlatGetValDefine" @closeUp='handleReset' ref="addAndUpdPlatGetValDefine"></addAndUpdPlatGetValDefine>
    ...
    methods: {
      ...
      pageTo(name) {
        ...
        switch (name) {
          ...
          this.$refs.platValdefinefield.getTableHeight()
            break
        }
        this[name] = true
