<template>
    <div class="cover">
        <div class="box">
            ...
            <Row class="table_form" @scroll="formScroll">
                <Form ref="formValidate"
                    ...
                    <i-col span="10"
                        ...
                        <FormItem :label="$t('lang_flow.dataBlock.flsdbSubisupd')"
                                  prop="flsdbSubisupd"
                                  v-if="formValidate.flsdbType ==='02subtable'">
                            <RadioGroup v-model="formValidate.flsdbSubisupd" type="button" size="small">
                    ...
                    <i-col span="21"
                           offset="1">
                        <FormItem :label="$t('lang_flow.dataBlock.comment')" style="margin-bottom:0 !important">
