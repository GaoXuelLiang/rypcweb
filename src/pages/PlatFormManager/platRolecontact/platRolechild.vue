...
export default {
    data () {
        return {
                    ...
                    render: (h, params) => {
                        ...
                        return h('div', [
                            h('Button', {
                                ...
                                on: {
                                    click: () => {
                                        this.showMsgBtn(params.row.id, this.$t('button.y.upd'), params.index, params)
                                    },
                                },
                            }, this.$t('button.y.upd')),
                        ])
            ...
            data: [],
            params: {
                _mt: this.$global.mt + 'PlatRolechild.getPage',
                AProws: 10,
                APpage: 1,
                APsort: 'id',
                APorder: 'desc',
                ...
                t.$Modal.confirm({
                    ...
                    onOk: () => {
                        ...
                        getDataLevelUserLoginData({
                            _mt: this.$global.mt + 'PlatRolechild.delByIds',
