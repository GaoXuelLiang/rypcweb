    ...
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          {{$t('lang_root.sysVar.title')}}
        </p>
        <Row class="btnHeight">
          <Input :placeholder="$t('lang_root.sysVar.p_platVarCode')" style="width: 200px" v-model="platVarCode"/>
          <Input :placeholder="$t('lang_root.sysVar.p_cplatVarCnname')" style="width: 200px;margin-left:5px" v-model="platVarCnname"/>
        ...
        <row class="table-form" ref="table-form">
          <Table @on-select="selectedtable" :no-data-text="noDataImg" :height='tableheight' :loading='loading' @on-select-cancel="selectedtable" @on-sort-change="sortable"  @on-select-all="selectedtable" @on-select-all-cancel="selectedtable" stripe  size="small"  ref="selection" :columns="columns" :data="data"></Table>
        </row>
...
<script>
  import update from './editPlatFormVar'
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_root.sysVar.platVarCode'),
            key: 'platVarCode',
//            width: 120,
            sortable: 'custom',
          },
          {
            title: this.$t('lang_root.sysVar.platVarCnname'),
            key: 'platVarCnname',
 //           width: 150,
            sortable: 'custom',
          },
...
    },
    ...
    methods: {
      getData(page) {
        ...
        const data = {
          _mt:  this.$global.mt+'PlatFormVar.queryList',
          sort: t.sort,
          order: t.order,
          rows: t.rows,
          page: t.page,
          funId: '1',
          logType: '查询List',
          platVarCode: t.platVarCode,
          platVarCnname: t.platVarCnname,
        }
          ...
          t.$Modal.confirm({
            ...
            onOk: () => {
              ...
              getDataLevelUserLogin({
                _mt:  this.$global.mt+'PlatFormVar.deleteByIds',
                funId: '1',
                companyId: '1',
      ...
      closeUp() {
        const t = this
        t.$refs.update.formValidate.platVarCode = ''
        t.$refs.update.formValidate.platVarCnname = ''
        t.$refs.update.formValidate.platVarDesc = ''
