<template>
    <div class="cover">
        <div class="box">
            ...
            <Row class="content">
                <Form :model="form"
                    ...
                    <i-col span="10" offset="1">
                        <FormItem :label="$t('lang_sysform.Sffvalid.sffvFieldname')"
                                  prop="sffvFieldname"
                                  :label-width="135">
                            <span @dblclick="clearpop1">
                                <Input v-model="sffvFieldnameDis"
                                       :placeholder="$t('lang_sysform.Sffvalid.sffvFieldname')"
                                       @on-click="openFiled"></Input>
                            </span>
                        </FormItem>
                    </i-col>
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_sysform.Sffvalid.sffvStyle')"
                                  prop="sffvStyle"
                                  :label-width="135">
                            <Select v-model="form.sffvStyle"
                                    :placeholder="$t('lang_sysform.Sffvalid.p_sffvStyle')">
                                <Option :value="item.paramCode"
                                        v-for="(item,index) in sffValidType"
                                        :key="index">{{item.paramInfoCn}}</Option>
                            </Select>
                        </FormItem>
                    </i-col>
                    <i-col span="10" offset="1">
                        <FormItem :label="$t('lang_sysform.Sffvalid.sffvValidvalue')"
                                  prop="sffvValidvalue"
                                  :label-width="135">
                            <Input v-model="form.sffvValidvalue"
                                   :placeholder="$t('lang_sysform.Sffvalid.p_sffvValidvalue')"></Input>
                        </FormItem>
                    </i-col>
                    <i-col span="10"
                           offset="1">
                        <FormItem label="是否必须"
                                  prop="sffvIsmust"
                                  :label-width="135">
                            <RadioGroup v-model="form.sffvIsmust" type="button" size="small">
                    ...
                    <i-col span="10" offset="1">
                        <FormItem :label="$t('lang_sysform.Sffvalid.sffvPrommsg')"
                                  prop="sffvPrommsg"
                                  ref="sffvPrommsg"
                                  :label-width="135">
                            <span @dblclick="clearpop2">
                                <Input v-model="sffvPrommsgDis"
                                        icon="ios-search"
                                       :placeholder="$t('lang_sysform.Sffvalid.p_sffvPrommsg')"
                                       @on-click="openLang"></Input>
                            </span>
                        </FormItem>
                    </i-col>
                    <i-col span="10"
                           offset="1">
                        <FormItem :label="$t('lang_sysform.Sffvalid.sffvMustmsg')"
                                  prop="sffvMustmsg"
                                  ref="sffvMustmsg"
                                  :label-width="135">
                            <span @dblclick="clearpop3">
                                <Input v-model="sffvMustmsgDis"
                                        icon="ios-search"
                                       :placeholder="$t('lang_sysform.Sffvalid.p_sffvMustmsg')"
                                       @on-click="openLang2"></Input>
                            </span>
                        </FormItem>
                    </i-col>
                </Form>
            ...
            <Row>
				<i-col span="21" offset="1">
					<Row type="flex" justify="end" class="btns">
        ...
        <transition name="fade">
            <platSffieldPop v-show="openFNameList"
                            :searchText1="searchText1"
                            :searchText2="searchText2"
                            :title="title1"
                            :searchCloumns="fieldCloumns"
                            :params="fieldParams"
                            @closeUp="closeTable"
                            @changeinput="changeinput"
                            ref="platSffieldPop"></platSffieldPop>
        </transition>
        <transition name="fade">
            <baseLangPop v-show="openPick"
                         :searchText3="searchText3"
                         :title="title2"
                         :searchCloumns="promCloumns"
                         :params="promParams"
                         @closeUp="closeTable"
                         @langchangeinput="langchangeinput"
                         ref="baseLangPop"></baseLangPop>
        </transition>
        <transition name="fade">
            <baseLangPop v-show="openPick2"
                         :searchText3="searchText3"
                         :title="title2"
                         :searchCloumns="promCloumns"
                         :params="mustParams"
...
export default {
    data () {
        return {
            ...
            sffvFieldnameDis: '',
            form: {
                _mt:  this.$global.mt+'PlatSffvalid.addOrUpd',
                sffvFieldname: '',
                sffvStyle: '',
                sffvValidvalue: '',
                sffvIsmust: '1',
    ...
    methods: {
        ...
        getFormData () {
            ...
            getDataLevelUserLogin({
                _mt:  this.$global.mt+'PlatSffvalid.getById',
