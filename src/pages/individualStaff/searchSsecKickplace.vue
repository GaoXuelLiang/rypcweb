    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;社保缴纳地
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="searchText" style="width: 200px" v-model="placCode"/>
  ...
  export default{
    data() {
      return {
        ...
        params: {
          _mt:  this.$global.mt+'SsecKickplace.getPage',
          APsort: 'id',
          APorder: 'asc',
          AProws: 10,
          APpage: 1,
          APffk:0,
          placValidState: '02valid'
        },
      }
    },
    props: {
    ...
    methods: {
      ...
      dbCkick(row) {
        const t = this
        this.$emit('changeinputSsecKickplace', row)
        t.close()
      },
      sizeChange(size) {
        const t = this
