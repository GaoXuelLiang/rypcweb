    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;{{typeName}}
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="searchText" style="width: 200px" v-model="secDesp"/>
  ...
  export default{
    data() {
      return {
        ...
        params: {
          _mt:  this.$global.mt+'SsecConnect.getCityPage',
          APsort: 'id',
          APorder: 'asc',
          AProws: 10,
          APpage: 1,
    ...
    methods: {
      ...
      getData() {
        ...
        data.cityId = t.cityId
        if(t.secDesp) {
          data.secDesp = t.secDesp
        }
      ...
      dbCkick(row) {
        const t = this
         this.$emit('changeinputSocSecunit', row)
