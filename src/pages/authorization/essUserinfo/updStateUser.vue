  ...
  <div class="background">
    <div class="backbox">
      ...
      <Row class="table-form">
            ...
            <span><Button class="btnStyle" style="width:56px" type="info" :loading="isSpin" @click="getData(sentParams)"><span v-if="!isSpin">{{$t('button.ser')}}</span></Button></span>
      ...
      <span style="margin-left: 10px;margin-top: 2px"> {{$t('reminder.view')}} {{((costParams.page - 1) * costParams.rows + 1)}} - {{costParams.page*costParams.rows > total ? total : costParams.page*costParams.rows}}  {{$t('reminder.of')}}  <span>{{total}}</span></span><Button size="small" shape="circle" icon="md-refresh" style="margin-left: 20px;display: inline-block;" @click="getData(1)"></Button></Row>
