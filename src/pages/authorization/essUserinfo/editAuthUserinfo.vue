        ...
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    ...
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_role.essrole.sysEssRolegrpDis')"
                              prop="sysEssRolegrpDis">
                        <span @dblclick="clearDubGrp">
                            <Input v-model="formValidate.sysEssRolegrpDis"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_role.essrole.psysEssRolegrpDis')"
                ...
                <Row>
                    ...
                    <FormItem :label="$t('lang_role.adminrole.validDis')"
                              prop="sysEssvalid">
                        <RadioGroup v-model="formValidate.sysEssvalid"
                                    type="button"
                                    size="small"
...
export default {
    data () {
        return {
            spinShow: false,
            formValidate: {
                _mt:  this.$global.mt+'SysUserinfo.addOrUpdEss',
                sysEssRolegrp: '',
                sysUserid: '',
                sysEssvalid: '1',
                sysEssRolegrpDis: '',
