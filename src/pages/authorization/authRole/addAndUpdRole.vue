<template>
    <div class="cover">
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootrole.companyIdDis')"
                              prop="companyIdDis">
                        <span @dblclick="clearDub">
                            <Input v-model="formValidate.companyIdDis"
                                   :disabled="disabled"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_user.rootrole.pcompanyIdDis')"
                                   @on-click="pickData" />
                        </span>
                    </FormItem>
                    </Col>
                ...
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootrole.roleCode')"
                              prop="roleCode">
                        <Input v-model="formValidate.roleCode"
                               :placeholder="$t('lang_user.rootrole.proleCode')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootrole.roleCname')"
                              prop="roleCname">
                        <Input v-model="formValidate.roleCname"
                               :placeholder="$t('lang_user.rootrole.proleCnamec')"></Input>
                    </FormItem>
                    </Col>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootrole.validDis')"
                              prop="valid">
                        <RadioGroup v-model="formValidate.valid"
                                    type="button"
                                    size="small"
                                    :placeholder="$t('lang_user.rootrole.pvalid')"
                ...
                <Row>
                    <Col span="10"
                         offset="1"
                         v-show="openInValid">
                    <FormItem :label="$t('lang_user.rootrole.invdate')"
                              prop="invdate">
                        <DatePicker type="date"
                                    :placeholder="$t('lang_user.rootrole.pinvdate')"
                                    :editable="false"
                ...
                <Row>
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootrole.roleDesc')"
                              prop="roleDesc">
                ...
                <Row v-show="openInValid">
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootrole.invreason')"
                              prop="invreason">
                ...
                <Row>
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootuser.memo')"
                              prop="comment">
        ...
        <transition name="fade">
            <searchCompDate v-show="openPick"
                            @closeUp="close"
...
export default {
    data () {
        return {
            ...
            openInValid: false,
            formValidate: {
                _mt:  this.$global.mt+'AuthRole.addOrUpdAuthRole',
                roleCode: '',
                companyIdDis: '',
                companyIdTi: '',
                roleCname: '',
    ...
    methods: {
        getData (id) {
            ...
            getDataLevelUserLogin({
                _mt:  this.$global.mt+'AuthRole.selAuthRoleByIds',
                ids: id,
            }).then((res) => {
                if (isSuccess(res, t)) {
        ...
        validChange () {
            if (this.formValidate.valid === '1') {
                ...
                if (this.formValidate.invdate) {
                    this.formValidate.invdate = ''
                }
                if (this.formValidate.invreason) {
