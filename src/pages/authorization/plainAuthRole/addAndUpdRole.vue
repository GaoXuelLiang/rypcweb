...
<!--          </Col>-->
          ...
          <FormItem :label="$t('lang_role.adminrole.validDis')" prop="valid">
            <RadioGroup v-model="formValidate.valid" type="button" size="small" :placeholder="$t('lang_role.adminrole.valid')" @on-change="validChange()">
  ...
  export default {
    data() {
      return {
        ...
        openInValid: false,
        formValidate: {
          _mt:  this.$global.mt+'AuthRole.addOrUpd',
          funId: '1',
          roleCode: '',
          roleCname: '',
          roleEname: '',
