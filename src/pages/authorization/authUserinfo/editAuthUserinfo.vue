<template>
    <div class="cover">
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootgrprole.companyIdDis')"
                              prop="companyIdDis">
                ...
                <Row>
                    ...
                    <FormItem :label="$t('lang_user.rootuser.name')"
                        ...
                        <span @dblclick="clearDubUser">
                            <Input v-model="formValidate.userName"
                                   ...
                                   :placeholder="$t('lang_user.rootuserrole.puserName')"
                                   icon="ios-search"
                                   :readonly="true"
                    ...
                    <!--            <Input v-model="formValidate.mobileNo" icon="ios-search" :readonly="true"-->
                    <!--                   :disabled="this.logType ===$t('button.view') ? true : false"></Input>-->
                    <!--          </FormItem>-->
                    <!--          </Col>-->
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootrole.loginName')"
                              prop="loginName">
                ...
                <Row>
                    ...
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootuserrole.sysUsadrolegrpDis')"
                              prop="sysUsadrolegrpDis">
                ...
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootgrprole.validDis')"
                              prop="sysAdminvalid">
                    ...
                    <Row type="flex"
                        ...
                        <FormItem>
                            ...
                            <Button type="primary"
                                    ...
                                    @click="handleSubmit"
                                    v-show="this.logType ===$t('button.y.upd') || this.logType === $t('button.add') ? true : false">
                                {{$t('button.sav')}}
                            </Button>
                        </FormItem>
                    </Row>
        ...
        <transition name="fade">
            <searchPubDate v-show="openPick"
                           @closeUp="close"
                           @changeinput="changeinput"
                           ref="searchPubDate"></searchPubDate>
        </transition>
        <transition name="fade">
...
export default {
    data () {
        return {
            spinShow: false,
            formValidate: {
                _mt:  this.$global.mt+'SysUserinfo.addOrUpdUserinfo',
                sysUsadrolegrp: '',
                sysUserid: '',
                sysAdminvalid: '1',
                companyIdTi: '',
