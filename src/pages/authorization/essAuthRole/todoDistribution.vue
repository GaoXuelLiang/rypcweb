<template>
  <div>
    <Row>
      ...
      <Row> -->
      <i-col span="21" style="margin-bottom: 10px;">
        <Button type="primary" @click="saveClumns1">{{$t('button.sav')}}</Button>
      </i-col>
      <i-col span="10" style="margin-bottom: 10px;">
      ...
      <i-col span="10">
        <Table border :loading="loading" :no-data-text="noDataImg" :columns="columns2" :data="data2" :height="375" @on-selection-change="cancelSelect1"
        ></Table>
      </i-col>
      <!-- </Row>
      </Col> -->
...
//          document.getElementById('col').style.height = '370px'
//        }
        const t = this;
        t.loading = true;
        t.isSpin = true;
