      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="135">
        ...
        <Row>
          ...
          <FormItem :label="$t('lang_authorization.authTodofine.autdValid')" prop="autdValid" :label-width="135">
            ...
            <RadioGroup v-model="formValidate.autdValid" type="button" size="small" :placeholder="$t('lang_authorization.authTodofine.autdValidDis')">
  ...
  export default {
    data() {
      return {
        ...
        disabled: false,
        formValidate: {
          _mt:  this.$global.mt+'AuthTododefine.addOrUpd',
          autdNo: '',
          autdName: '',
          autdPlatform: '',
          autdProp: '',
        ...
        ruleValidate: {
          ...
          autdPlatform: [
            { required: true, message: this.$t('lang_authorization.authTodofine.autdPlatformDis'), trigger: 'change' },
          ],
          autdProp: [
            { required: true, message: this.$t('lang_authorization.authTodofine.autdPropDis'), trigger: 'change' },
          ],
          autdThread: [
    ...
    methods: {
      getData(id) {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'AuthTododefine.getById',
          logType:'根据id获取信息',
          id: id,
        }).then((res) => {
          if (isSuccess(res, t)) {
