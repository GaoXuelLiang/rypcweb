    ...
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          {{$t('lang_authorization.authTodofine.title')}}
        </p>
        <Row class="btnHeight">
          <Input class="searchInput" :placeholder="$t('lang_authorization.authTodofine.autdNoDis')" style="width: 200px" v-model="autdNo"/>
          <Input class="searchInput" :placeholder="$t('lang_authorization.authTodofine.autdNameDis')" style="width: 200px" v-model="autdName"/>
...
<script>
  import update from './editTododefine'
  ...
  export default{
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_authorization.authTodofine.autdNo'),
            key: 'autdNo',
            sortable: 'custom',
            // width: 150,
            width: 180,
          ...
          {
            title: this.$t('lang_authorization.authTodofine.autdName'),
            key: 'autdName',
            sortable: 'custom',
            // width: 220,
            width: 270,
          ...
          {
            title: this.$t('lang_authorization.authTodofine.autdPlatform'),
            key: 'autdPlatformDis',
            sortable: 'custom',
            // width: 200,
            width: 230,
          ...
          {
            title: this.$t('lang_authorization.authTodofine.autdProp'),
            key: 'autdPropDis',
            sortable: 'custom',
            // width: 220,
            width: 250,
          ...
          {
            title: this.$t('lang_authorization.authTodofine.autdThread'),
            key: 'autdThread',
            sortable: 'custom',
            // width: 260,
            width: 380,
          ...
          {
            title: this.$t('lang_authorization.authTodofine.autdValid'),
            key: 'autdValidDis',
            sortable: 'custom',
            // width: 180,
            width: 230,
    ...
    methods: {
      getData(page) {
        ...
        const data = {
          _mt:  this.$global.mt+'AuthTododefine.getPage',
          sort: t.sort,
          order: t.order,
          rows: t.rows,
          page: t.page,
      ...
      deletemsg() {
        ...
        if (t.tableselected.length === 0) {
         ...
         t.$Modal.confirm({
          ...
          _mt:  this.$global.mt+'AuthTododefine.delByIds',
