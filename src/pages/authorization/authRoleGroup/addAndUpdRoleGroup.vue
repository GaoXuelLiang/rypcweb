        ...
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootgrprole.rolegrpCode')"
                              prop="rolegrpCode">
                        <Input v-model="formValidate.rolegrpCode"
                               :placeholder="$t('lang_user.rootgrprole.prolegrpCode')"></Input>
                    </FormItem>
                    </Col>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootgrprole.rolegrpCname')"
                              prop="rolegrpCname">
                        <Input v-model="formValidate.rolegrpCname"
                               :placeholder="$t('lang_user.rootgrprole.pprolegrpCname')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                ...
                <Row>
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootgrprole.rolegrpDesc')"
                              prop="rolegrpDesc">
                        <Input v-model="formValidate.rolegrpDesc"
                               type="textarea"
                ...
                <Row>
                    ...
                    <FormItem :label="$t('lang_user.rootgrprole.validDis')"
                        ...
                        <RadioGroup v-model="formValidate.valid"
                                    type="button"
                                    size="small"
                                    :placeholder="$t('lang_user.rootgrprole.valid')"
                    ...
                    <Col span="10"
                         offset="1"
                         v-show="openInValid">
                    <FormItem :label="$t('lang_user.rootgrprole.invdate')"
                              prop="invdate">
                        <span @dblclick="clear">
                            <DatePicker type="date"
                                        :placeholder="$t('lang_user.rootgrprole.pinvdate')"
                                        :editable="false"
                ...
                <Row v-show="openInValid">
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_user.rootgrprole.invreason')"
                              prop="invreason">
