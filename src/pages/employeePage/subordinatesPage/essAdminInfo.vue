    ...
    <div class="box">
      ...
      <div class="contentdiv">
        <div class="essinfo">
          ...
          <Tabs @on-click="getData" type="card">
    ...
    methods: {
      getviewEmpMaster() {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'ViewEmpMaster.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
      ...
      getEmpBase() {
        const t = this
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EmpBase.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
            this.base = res.data.content[0]
          }
        }).catch(() => {
          this.$Modal.error({
            title: this.$t('reminder.err'),
      ...
      getEmpContract() {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EmpContract.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
      ...
      getEducation() {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EmpEducation.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
      ...
      getWorkExp() {
        ...
        t.showWorkExp = false
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EmpWorkExp.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
      ...
      getAddress() {
        ...
        t.showAddress = false
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EmpAddress.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
      ...
      getContact() {
        const t = this
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EmpContact.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
      ...
      getFamily() {
        ...
        t.showFamily = false
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'EmpFamily.getByUser',
          empId: t.empId,
          logType: '根据员工id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
...
<style scoped lang="scss">
  ...
  .essinfo{
    ...
    margin-left: 50%;
    padding-top: 233px;
    background: url('../../../../static/img/esshead.png') no-repeat;
