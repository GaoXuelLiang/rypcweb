    ...
    <div class="table">
        <Row>
            ...
            <card>
                ...
                <Row>
                    <Input :placeholder="$t('lang_baseManage.baseSscoverage.sscCodeDis')"
                           style="width: 200px"
                           v-model="sscCode" />
...
export default {
    ...
    data () {
        return {
            isSpin: false,
            imp_mt:  this.$global.mt+'BaseSscoverage.importData',
            openImport: false,
                ...
                t.$Modal.confirm({
                    ...
                    onOk: () => {
                        getDataLevelUserLogin({
                            _mt:  this.$global.mt+'BaseSscoverage.delByIds',
                            funId: '1',
