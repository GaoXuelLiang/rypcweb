      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="135">
        ...
        <Row>
          ...
          <FormItem :label="$t('lang_baseManage.autocode.autoTimeformatName')" prop="autoTimeformat">
            <Select v-model="formValidate.autoTimeformat" :placeholder="$t('lang_baseManage.autocode.autoTimeformatNameIns')">
        ...
        <Row>
          ...
          <FormItem :label="$t('lang_baseManage.autocode.autoValidityName')" prop="autoValidity" :label-width="135">
            <RadioGroup v-model="formValidate.autoValidity" type="button" size="small" :placeholder="$t('lang_baseManage.autocode.autoValidityIns')">
        ...
        <Row>
          <Col span="21" offset="1">
          <Row type="flex" justify="end" style="font-size:0">
            <FormItem>
  ...
  export default {
    data() {
      ...
      return {
        ...
        selectIsType: [],
        formValidate: {
          _mt:  this.$global.mt+'BaseAutocode.addOrUpd',
          funId: '1',
          autoFlag: '',
          autoName: '',
          autoPrefix: '',
    ...
    methods: {
      getData(id) {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'BaseAutocode.getById',
          id: id,
          logType: '根据id获取数据',
        }).then((res) => {
          if (isSuccess(res, t)) {
