        ...
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_baseManage.baseLevadfamount.levdfCityName')"
                              prop="levdfCityid">
                        <span @dblclick="clearCityid">
                            <Input v-model="levdfCityName"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_baseManage.baseLevadfamount.selCity')"
                                   @on-click="pickData" />
                        </span>
                    </FormItem>
                    </Col>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_baseManage.baseLevadfamount.levdfDfamount')"
                              prop="levdfDfamount">
                        <Input v-model="formValidate.levdfDfamount"
                               :placeholder="$t('lang_baseManage.baseLevadfamount.levdfDfamountDis')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_baseManage.baseLevadfamount.levdfSdate')"
                              prop="levdfSdate">
                        <DatePicker type="date"
                                    :placeholder="$t('lang_baseManage.baseLevadfamount.levdfSdateDis')"
                                    :editable="false"
                                    v-model="formValidate.levdfSdate"
                                    style="width: 100%"></DatePicker>
                    </FormItem>
                    </Col>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_baseManage.baseLevadfamount.levdfEdate')"
                              prop="levdfEdate">
                        <DatePicker type="date"
                                    :placeholder="$t('lang_baseManage.baseLevadfamount.levdfEdateDis')"
                                    :editable="false"
                                    v-model="formValidate.levdfEdate"
                                    style="width: 100%"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_baseManage.baseLevadfamount.comment')"
                              prop="comment">
                        <Input v-model="formValidate.comment"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_baseManage.baseLevadfamount.commentDis')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
...
export default {
    data () {
        return {
            ...
            updateImg: false,
            formValidate: {
                _mt:  this.$global.mt+'BaseLevadfamount.addOrUpd',
                funId: '1',
                levdfCityid: '',
                levdfDfamount: '',
                levdfSdate: '',
    ...
    methods: {
        getData (id) {
            ...
            getDataLevelUserLogin({
                _mt:  this.$global.mt+'BaseLevadfamount.getById',
                id: id,
                logType: '根据id获取数据',
            }).then((res) => {
                if (isSuccess(res, t)) {
