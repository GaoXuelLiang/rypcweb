        ...
        <Row>
            ...
            <card>
                <p slot="title">
                    ...
                    &nbsp;{{$t('lang_baseManage.baseCurrency.title')}}
                </p>
                <Row>
                    <Input :placeholder="$t('lang_baseManage.baseCurrency.currCurrencyDis')"
                           style="width: 200px"
...
<script>
import update from './addNewCurrency'
...
export default {
    ...
    data () {
        return {
            isSpin: false,
            imp_mt:  this.$global.mt+'BaseCurrency.importData',
            openImport: false,
            expDataTital: [{ code: 'currCurrency', name: this.$t('lang_baseManage.baseCurrency.currCurrency') }, { code: 'currCode1', name: this.$t('lang_baseManage.baseCurrency.currCode1') },
            { code: 'currCode2', name: this.$t('lang_baseManage.baseCurrency.currCode2') }, { code: 'currCode3', name: this.$t('lang_baseManage.baseCurrency.currCode3') },
            { code: 'comment', name: this.$t('lang_baseManage.baseCurrency.comment') }],
            openExpDow: false,
            openExp: false,
            filekey: '',
            filename: '',
            ...
            columns: [
                ...
                {
                    title: this.$t('lang_baseManage.baseCurrency.currCode2'),
                    key: 'currCode2',
                    sortable: 'custom',
                    //          width: 130,
                },
                {
                    title: this.$t('lang_baseManage.baseCurrency.currCode3'),
                    key: 'currCode3',
                    sortable: 'custom',
                    //          width: 130,
                },
    ...
    methods: {
        ...
        expData () {
            ...
            this.$refs.expwindow.getData(this.expDataTital, 'baseCurrency.export', data)
            this.openExp = true
        },
        closeExp () {
            const t = this
                ...
                t.$Modal.confirm({
                    ...
                    onOk: () => {
                        getDataLevelUserLogin({
                            _mt:  this.$global.mt+'BaseCurrency.delByIds',
                            funId: '1',
        ...
        closeUp () {
            const t = this
            t.openUpdate = false
            t.$refs.update.formValidate.currCurrency = ''
            t.$refs.update.formValidate.currCode1 = ''
            t.$refs.update.formValidate.currCode2 = ''
            t.$refs.update.formValidate.currCode3 = ''
