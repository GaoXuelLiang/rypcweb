    ...
    <div class="table">
        <Row>
            ...
            <card>
                ...
                <Row>
                    <Input :placeholder="$t('lang_baseManage.baseNereason.nerCodeDis')"
                           style="width: 200px"
                           v-model="nerCode" />
...
export default {
    ...
    methods: {
        ...
        expData () {
            ...
            this.$refs.expwindow.getData(this.expDataTital,  this.$global.mt+'BaseNereason.export', data)
            this.openExp = true
        },
        closeExp () {
            const t = this
                ...
                t.$Modal.confirm({
                    ...
                    onOk: () => {
                        getDataLevelUserLogin({
                            _mt:  this.$global.mt+'BaseNereason.delByIds',
                            funId: '1',
