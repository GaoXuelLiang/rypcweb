...
<script>
  ...
  import updFlowStep from './flowStepView/baseInfo'
  import updFlsRelation from './flowStepView/updFlsRelation'
...
//          console.log(obj, 'obj')
      ...
      addNode(dataSource) {
        ...
        this.$refs.flowStep.setId(data.id)
...
//        console.log(edges, nodes)
      ...
      deleteNode() {
        let t = this
        let data2 = {
          _mt:  this.$global.mt+'PlatAprvstep.delByIds',
          APlogType: '刪除',
          APdelIds: t.delMesg.get('model').setpBlockId,
          APfunId:'3333'
        }
