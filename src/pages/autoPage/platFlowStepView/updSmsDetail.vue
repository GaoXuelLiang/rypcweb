...
                  v-if="spinShow"></Spin>
      ...
      <Row class="content form_box">
        <Form :model="form" disabled label-position="right" :rules="ruleValidate"  :label-width="135" ref="form">
          ...
          <i-col span="21" offset="1">
            <FormItem :label="$t('lang_flow.SMS.flsmsSendconditionDis')" prop="flsmsSendconditionDis">
              <span @dblclick="clearCondition">
                 <Input v-model="form.flsmsSendconditionDis" type="textarea" readonly="readonly" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_flow.SMS.p_flsmlSendconditionDis')" class="settlement"></Input>
            	</span>
          ...
          <i-col span="21" offset="1" v-show="form.flsmsIsvalid ==='0'?true:false">
