    ...
    <div class="background">
        <div class="backbox">
            ...
            <Form ref="form"
                ...
                <Row>
                    ...
                    <Row style="margin-bottom: 0;">
                        <Col span="10">
                        <FormItem :label="$t('lang_homePage.calendarList.remindStatime')"
                                  prop="remindStatime">
                            <DatePicker type="date"
                                        v-model="form.remindStatime"
                                        :placeholder="$t('lang_homePage.calendarList.remindStatimeDis')"
                                        class="width200"></DatePicker>
                        </FormItem>
                        </Col>
                        <Col span="1"
                             style="text-align: center; margin:0 13px 0 72px; line-height: 30px; color: #999;">——</Col>
                        <Col span="8">
                        <FormItem prop="remindStatimeHour"
                                  style="margin-left:-72px;">
                            <TimePicker type="time"
                                        :placeholder="$t('lang_homePage.calendarList.remindHourtimeDis')"
                                        v-model="form.remindStatimeHour"
                                        style="width:160px;"></TimePicker>
                        </FormItem>
                        </Col>
                    </Row>
                    </Col>
                ...
                <Row>
                    ...
                    <Row style="margin-bottom: 0;">
                        <Col span="10">
                        <FormItem prop="remindStoptime"
                                  :label="$t('lang_homePage.calendarList.remindStoptime')">
                            <DatePicker type="date"
                                        v-model="form.remindStoptime"
                                        :placeholder="$t('lang_homePage.calendarList.remindStoptimeDis')"
                                        class="width200"></DatePicker>
                        </FormItem>
                        </Col>
                        <Col span="1"
                             style="text-align: center; margin:0 13px 0 72px; line-height: 30px; color: #999;">——</Col>
                        <Col span="8">
                        <FormItem prop="remindStoptimeHour"
                                  style="margin-left:-72px;">
                            <TimePicker type="time"
                                        :placeholder="$t('lang_homePage.calendarList.remindHourtimeDis')"
                                        v-model="form.remindStoptimeHour"
                                        style="width:160px;"></TimePicker>
                        </FormItem>
                        </Col>
                    </Row>
                ...
                <Row>
                    <Col span="10">
                    <FormItem :label="$t('lang_homePage.calendarList.remindType')"
                              prop="remindType"
                              :label-width="135">
                        <Select v-model="form.remindType"
                                :placeholder="$t('lang_homePage.calendarList.remindTypeDis')"
                                :transfer="true">
                            <Option :value="item.paramCode"
                                    v-for="(item,index) in selectRemindType"
                ...
                <Row>
                    <Col span="23">
                    <FormItem :label="$t('lang_homePage.calendarList.remindTitle')"
                              prop="remindTitle">
                        <Input v-model="form.remindTitle"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_homePage.calendarList.remindTitleDis')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="23">
                    <FormItem :label="$t('lang_homePage.calendarList.remindContent')"
                              prop="remindContent">
                        <Input v-model="form.remindContent"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_homePage.calendarList.remindContentDis')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="23">
                    <FormItem :label="$t('lang_homePage.calendarList.remindNote')"
                              prop="remindNote"
                              offset="1">
                        <Input v-model="form.remindNote"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_homePage.calendarList.remindNoteDis')"></Input>
                    </FormItem>
                    </Col>
                </Row>
            </Form>
            <Row style="margin-top:20px;">
                ...
                <Row type="flex"
                     justify="end">
                    <Button@click="close" style="margin-right: 5px">{{$t('button.cal')}}</Button>
                        <Button type="primary"
                                v-show="disCalen"
...
export default {
    data () {
        ...
        return {
            form: {
                _mt: this.$global.mt + 'CmutRemind.addOrUpd',
                remindType: '',
                remindContent: '',
                remindTitle: '',
                remindStatime: '',
    ...
    methods: {
        getData (id) {
            ...
            getDataLevelUserLoginData({
                _mt: this.$global.mt + 'CmutRemind.getById',
                APid: id,
            }).then((res) => {
                if (isSuccess(res, t)) {
        ...
        handleSubmit () {
            ...
            t.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    data['APremindPlat'] = t.$store.state.user.roleType
