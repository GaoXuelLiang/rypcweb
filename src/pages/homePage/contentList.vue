<template>
    <div class="main">
        ...
        <div class="message_box">
            <div class="message"
                ...
                <div class="right"
                    ...
                    <p>
                        <Icon type="email" />
                        <a :href="'mailto:'+item.platSerEmail"
                           style="text-decoration:underline">{{item.platSerEmail}}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <Modal v-model="modal1"
               class="modalCenter"
               :title="$t('lang_homePage.contentList.modaTitle')"
               width="800"
            ...
            <div class="modalDiv">
                ...
                <p>
                    ...
                    <a :href="'mailto:'+platSerEmail"
                       style="text-decoration:underline">{{platSerEmail}}</a>
                </p>
            </div>
            <div slot="footer">
                <Button type="primary"
                        size="large"
                        long
                        @click=" modal1 = false">{{$t('button.clo')}}</Button>
            </div>
        </Modal>
        <Modal v-model="modal2"
            ...
            <div slot="footer">
                <div style="display: flex;justify-content: space-between;">
                    ...
                    <span>
                        <Button type="primary"
                                @click="modal2 = false">{{$t('button.clo')}}</Button>
                    </span>
                </div>
            </div>
        </Modal>
...
export default {
    ...
    methods: {
        getData () {
            // const t = this
            // const data = {
            //     _mt: this.$global.mt + 'PlatBusirel.getList',
            //     APfunId: 1,
            //     APlogType: '查询消息',
            //     APsort: 'id',
            //     APorder: 'desc',
...
/deep/ .ivu-card-bordered {
    border-top: 4px solid #3a8de0;
}
.modalCenter /deep/ .ivu-modal-wrap {
    display: flex;
    align-items: center;
}
