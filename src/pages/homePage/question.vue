<template>
    <i-col class="col"
        ...
        <card :bordered="false">
            <p slot="title"
               class="title">
                <Icon type="android-textsms"></Icon> <span style="margin-left: 5px;">{{$t('lang_homePage.question.title')}}</span>
            </p>
            <a href="#"
               slot="extra"
               @click="clickHandle">
            ...
            <div class="block short">
                <div class="ask_block_main">
                    <div class="ask_item">
                        ...
                        <div class="item_right">
                            <div class="number"
                                 style="color:#41b3f9">{{waitNum}}</div>
                    ...
                    <div class="ask_item">
                        ...
                        <div class="item_right">
                            <div class="number"
                                 style="color:#ff9900">{{addNum}}</div>
                            <div>{{$t('lang_homePage.question.dayAdd')}}</div>
                        </div>
                    </div>
                    <div class="ask_item">
                        <div class="item_left">
                            <Icon type="ios-minus-outline"
                                  color="#fff"></Icon>
                        </div>
                        <div class="item_right">
                            <div class="number"
                                 style="color:#64d572">{{delNum}}</div>
                ...
                <div class="block_row"
                    ...
                    <div style="border: 1px solid #ff9900;color:#ff9900"
                         class="icon_end">
