    ...
    <i-col class="col"
        ...
        <card :bordered="false">
            <p slot="title"
               class="title">
                <Icon type="md-mail"
                      size="18"></Icon> <span style="margin-left: 5px;">{{$t('lang_homePage.sms.title')}}</span>
            </p>
            <a href="#"
               slot="extra">
                <Icon type="ios-more"
    ...
    methods: {
        getDate () {
            ...
            getDataLevelUserLoginData({
                _mt: this.$global.mt + 'AnsrptStatistics.Smsstatistics',
            }).then((res) => {
                if (isSuccess(res, t)) {
