                ...
                <Form ref="loginForm"
                    ...
                    <FormItem prop="phoneCode">
                        <Row>
                            ...
                            <Button type="primary"
                                    long
                                    :disabled="time>0"
                                    @click="getPhoneCode">{{time > 0 ? time + 's' : '获取验证码'}}
                            </Button>
                            </Col>
                        </Row>
                    </FormItem>
                    ...
                    <FormItem prop="check"
                        ...
                        <Checkbox v-model="form.check"
                                  class="input">同意<a href="#">用户协议</a></Checkbox>
                        <span slot="prepend">
                            <Icon :size="14"
                                  type="locked"></Icon>
                        </span>
            ...
            this.$refs.loginForm.validate((valid) => {
                if (valid) {
                    ...
                    if (regx.test(t.form.password)) {
                        getDataLevelNone({
                            _mt: this.$global.mt + 'UserInfo.register',
                            APmobileNo: t.form.userName,
                            // email: t.form.email,
                            APverifyCode: t.form.phoneCode,
                            APverifyid: t.deliveryId,
                            APcaptchaCode: t.form.noteCode,
                            APcaptid: t.noteCodeKey,
                            APname: t.form.realName,
                            APtermAgreed: t.form.check === true ? 1 : 0,
