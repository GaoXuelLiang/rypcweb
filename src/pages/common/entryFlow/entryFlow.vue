        ...
        <Row>
            ...
            <card>
                <p slot="title">
                    ...
                    &nbsp;{{$t('lang_communication.entryFlow.title')}}
                </p>
                <Row>
                    <i-col span="24">
                        {{$t('lang_communication.workorderSearch.cmwdCode')}}：<Input :placeholder="$t('lang_communication.workorderSearch.cmwdCodeDis')"
                               v-model="cmwdCode"
                               style="width: 100px;" />
                        {{$t('lang_communication.myWorkOrderNew.cmwdkeyWord')}}：<Input :placeholder="$t('lang_communication.myWorkOrderNew.cmwdkeyWordDis')"
                               v-model="cmwdkeyWord"
                               style="width: 100px;" />
                        {{$t('lang_communication.entryFlow.flowWorkno')}}：<Input :placeholder="$t('lang_communication.entryFlow.flowWorknoDis')"
                               v-model="flowWorkno"
                               style="width: 100px;" />
                        <span @dblclick="dbHCompany">
                            {{$t('lang_communication.entryFlow.pladCompany')}}<Input v-model="pladCompanyDis"
                                   :placeholder="$t('lang_communication.entryFlow.pladCompanyDis')"
                                   style="width: 100px"
                                   icon="ios-search"
                                   :readonly="true"
                        ...
                        <span @dblclick="clearDepart">
                            {{$t('lang_communication.entryFlow.pladDept')}}<Input v-model="pladDeptDis"
                                   style="width: 100px"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_communication.entryFlow.pladDeptDis')"
                                   @on-click="pickDepart" />
                        </span>
                        {{$t('lang_communication.entryFlow.flowCName')}}：<Input :placeholder="$t('lang_communication.entryFlow.flowCNameDis')"
                               v-model="flowCName"
                               style="width: 100px;" />
                        <span>
...
//  import commonFlowUpdate from './commonFlowUpdate.vue'
    ...
    methods: {
        ...
        businessLook (pRow) {
            ...
            getDataLevelUserLoginId({
                ...
                // 格式funId_flowId_roleType_stepId_dataId
                t.$router.push({
                    path: 'entryFlow_Edit',
                    query: {
