  ...
  <div>
    <div class="cover">
      <div class="box">
        ...
        <div class="dataBlocks" v-for="(item, index) in [1]" :key="index">
          <div class="content">
        ...
        <div class="footer">
          <Button  style="margin-right: 5px" v-if="showflag" @click="close">{{$t('button.cal')}}</Button>
    ...
    methods: {
      getColumn() {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'SubGetEdit.getEditColumn',
...
* */
      getFormDataSubmit(data) {
        ...
        // -----
        form._mt =  this.$global.mt+'SubTableSave.addOrUpd'
        ...
        formData.dis = dis
        console.log(formData, '222222222222222222222222')
        return formData
      },
      close() {
        this.$emit('closePage')
