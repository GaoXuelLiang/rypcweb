        ...
        <Row>
            ...
            <card>
                <p slot="title">
                    ...
                    &nbsp;{{$t('lang_communication.interFlow.title')}}
                </p>
                <Row>
                    <i-col span="24">
                        ...
                        {{$t('lang_communication.myWorkOrderNew.cmwdkeyWord')}}：<Input :placeholder="$t('lang_communication.myWorkOrderNew.cmwdkeyWordDis')"
                               v-model="cmwdkeyWord"
                               style="width: 100px;" />
                        {{$t('lang_communication.interFlow.flowWorkno')}}：<Input :placeholder="$t('lang_communication.interFlow.flowWorknoDis')"
                               v-model="flowWorkno"
                               style="width: 100px;" />
                        <span @dblclick="dbHCompany">
                            {{$t('lang_communication.interFlow.pladCompany')}}<Input v-model="pladCompanyDis"
                                   :placeholder="$t('lang_communication.interFlow.pladCompanyDis')"
                                   style="width: 100px"
                                   icon="ios-search"
                                   :readonly="true"
                        ...
                        <span @dblclick="clearDepart">
                            {{$t('lang_communication.interFlow.pladDept')}}<Input v-model="pladDeptDis"
                                   style="width: 100px"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_communication.interFlow.pladDeptDis')"
                                   @on-click="pickDepart" />
                        </span>
                        {{$t('lang_communication.interFlow.flowCName')}}：<Input :placeholder="$t('lang_communication.interFlow.flowCNameDis')"
                               v-model="flowCName"
                               style="width: 100px;" />
                        <span>
