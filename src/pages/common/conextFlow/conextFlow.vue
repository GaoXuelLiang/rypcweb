        ...
        <Row>
            ...
            <card>
                <p slot="title">
                    ...
                    &nbsp;{{$t('lang_communication.contextFlow.title')}}
                </p>
                <Row>
                    <i-col span="24">
                        ...
                        {{$t('lang_communication.myWorkOrderNew.cmwdkeyWord')}}：<Input :placeholder="$t('lang_communication.myWorkOrderNew.cmwdkeyWordDis')"
                               v-model="cmwdkeyWord"
                               style="width: 100px;" />
                        {{$t('lang_communication.contextFlow.flowWorkno')}}：<Input :placeholder="$t('lang_communication.contextFlow.flowWorknoDis')"
                               v-model="flowWorkno"
                               style="width: 100px;" />
                        <span @dblclick="dbHCompany">
                            {{$t('lang_communication.contextFlow.pladCompany')}}<Input v-model="pladCompanyDis"
                                   :placeholder="$t('lang_communication.contextFlow.pladCompanyDis')"
                                   style="width: 100px"
                                   icon="ios-search"
                                   :readonly="true"
                        ...
                        <span @dblclick="clearDepart">
                            {{$t('lang_communication.contextFlow.pladDept')}}<Input v-model="pladDeptDis"
                                   style="width: 100px"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_communication.contextFlow.pladDeptDis')"
                                   @on-click="pickDepart" />
                        </span>
                        {{$t('lang_communication.contextFlow.flowCName')}}：<Input :placeholder="$t('lang_communication.contextFlow.flowCNameDis')"
                               v-model="flowCName"
                               style="width: 100px;" />
                        <span>
