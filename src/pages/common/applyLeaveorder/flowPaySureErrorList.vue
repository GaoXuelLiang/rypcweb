  ...
  <div class="cover">
    <div class="box">
      ...
      <div class="content-main">
          ...
          <Button type="primary" @click='checkManyCommint' v-if="!(isbtnDisplay=='p_flowst_3')" :disabled="(parseInt(payproRound.slice(0,2))!=parseInt(roundNumber.slice(0,2)))||thisStepState=='p_flowst_3'">批量确认</Button>
        </Row>
