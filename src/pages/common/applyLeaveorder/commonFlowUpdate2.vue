        ...
        <Form ref="ruleForm" :model="ruleForm" :rules="ruleValidate" :label-width="200">
              ...
              <div class="dataBlocks" v-for="(item, index) in dataBlocks" :key="index">
                ...
                <div style="width:100%;"  v-if="item.flsdbMark.split('_')[1]=='1100'">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="22" offset="1">
                      <p >{{$t('lang_communication.commonFlowUpdate2.paylink2')}}： <Checkbox v-model="ruleForm.payproPrisup" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update'))"> </Checkbox></p>
                      </Col>
                ...
                <div style="width:100%;"  v-if="item.flsdbMark.split('_')[1]=='1100'">
                  ...
                  <div class="dataContent">
                    ...
                    <Row v-for="(itemsub,indexsub) in confirmorList" :key="indexsub">
                      <Col span="22" offset="1">
                      <p  style="height:30px;line-height:30px;">{{$t('lang_communication.commonFlowUpdate2.paylink3')}}（{{itemsub.paypcfName}}）： <Checkbox v-model="itemsub.paypcfIsconfirm" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update'))"> </Checkbox></p>
                      </Col>
                    </Row>

                  </div>
                </div>
                <div style="width:100%;"  v-if="item.flsdbName==$t('lang_communication.commonFlowUpdate2.mailRecord')">
                  <div class="dataBlocksTitle">
                    <Icon type="compose" style="margin-right: 5px;"></Icon>{{item.flsdbName}}
                  </div>
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <FormItem :label="$t('lang_communication.commonFlowUpdate2.payPlan')" prop="payproPeriod">
              ...
              <div class="dataBlocks" v-for="(item, index) in dataBlocks" :key="index">
                ...
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1100')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=1)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payproPlandate')}}：</span><span class="item_sub_2" v-if="(salaryComputationObj.payproPlandate.indexOf('#')==-1)||((salaryComputationObj.payproPlandate.indexOf('#')!=-1)&&salaryComputationObj.payproPlandate.split('#').length>=1)">{{salaryComputationObj.payproPlandate.split('#')[0]}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline;margin-right:10px" href="javascript:void(0);" @click="btnAlertListModel('01round')" >{{$t('button.view')}}</a>
                                    <a style="text-decoration:underline" download="" @click="btnisErrorList('01round')" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))==1))">{{$t('button.cek')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline"  v-if="payproSalset.errorNum.length>=1" href="javascript:void(0);" @click="openErrorListModel('01round')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.errTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorNum.length>=1">{{payproSalset.errorNum[0]}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.nohandErrTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorpendNum.length>=1">{{payproSalset.errorpendNum[0]}}</span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operator')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList[0].paypcfRound === '01round'">{{payproSalset.confirmorList[0].paypcfOperatorcalDis}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operatatetime')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList[0].paypcfRound === '01round'">{{payproSalset.confirmorList[0].paypcfOptimecal}}</span></p>
                      </Col>
                    </Row>
                  </div>
                </div>
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1200')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=2)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payproPlandate')}}：</span><span class="item_sub_2" v-if="(salaryComputationObj.payproPlandate.indexOf('#')!=-1)&&salaryComputationObj.payproPlandate.split('#').length>=2">{{salaryComputationObj.payproPlandate.split('#')[1]}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline;margin-right:10px" href="javascript:void(0);" @click="btnAlertListModel('02round')" >{{$t('button.view')}}</a>
                                    <a style="text-decoration:underline" download="" @click="btnisErrorList('02round')" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))==2))">{{$t('button.cek')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline" v-if="isErrorList" href="javascript:void(0);" @click="openErrorListModel('02round')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.errTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorNum.length>=2">{{payproSalset.errorNum[1]}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.nohandErrTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorpendNum.length>=2">{{payproSalset.errorpendNum[1]}}</span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operator')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList[1].paypcfRound === '02round'">{{payproSalset.confirmorList[1].paypcfOperatorcalDis}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operatatetime')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList[1].paypcfRound === '02round'">{{payproSalset.confirmorList[1].paypcfOptimecal}}</span></p>
                      </Col>
                    </Row>
                  </div>
                </div>
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1300')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=3)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payproPlandate')}}：</span><span class="item_sub_2" v-if="(salaryComputationObj.payproPlandate.indexOf('#')!=-1)&&salaryComputationObj.payproPlandate.split('#').length>=3">{{salaryComputationObj.payproPlandate.split('#')[2]}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline;margin-right:10px" href="javascript:void(0);" @click="btnAlertListModel('03round')" >{{$t('button.view')}}</a>
                                    <a style="text-decoration:underline" download="" @click="btnisErrorList('03round')" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))==3))">{{$t('button.cek')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline" v-if="isErrorList" href="javascript:void(0);" @click="openErrorListModel('03round')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.errTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorNum.length>=3">{{payproSalset.errorNum[2]}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.nohandErrTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorpendNum.length>=3">{{payproSalset.errorpendNum[2]}}</span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operator')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList[2].paypcfRound === '03round'">{{payproSalset.confirmorList[2].paypcfOperatorcalDis}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operatatetime')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList[2].paypcfRound === '03round'">{{payproSalset.confirmorList[2].paypcfOptimecal}}</span></p>
                      </Col>
                    </Row>
                  </div>
                </div>
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1400')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=90)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      ...
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline;margin-right:10px" href="javascript:void(0);" @click="btnAlertListModel('90final')" >{{$t('button.view')}}</a>
                                    <a style="text-decoration:underline" download="" @click="btnisErrorList('90final')" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))==90))">{{$t('button.cek')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline" v-if="isErrorList" href="javascript:void(0);" @click="openErrorListModel('90final')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.errTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorNum.length>=4">{{payproSalset.errorNum[3]}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.nohandErrTotal')}}：</span><span class="item_sub_2" v-if="payproSalset.errorpendNum.length>=4">{{payproSalset.errorpendNum[3]}}</span></p>
                      </Col>
                    </Row>
                    <!--<Row>-->
                    <!--<Col span="10" offset="1">-->
                    <!--<p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operator')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList.length>=4">{{payproSalset.confirmorList[3].paypcfOperatorcalDis}}</span></p>-->
                    <!--</Col>-->
                    <!--<Col span="10" offset="1">-->
                    <!--<p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operatatetime')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList.length>=4">{{payproSalset.confirmorList[3].paypcfOptimecal}}</span></p>-->
                    <!--</Col>-->
                    <!--</Row>-->
                    <Row v-if="payproSalset.confirmorList.length == 4 ">
                      <Col span="10" offset="1" >
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operator')}}：</span><span class="item_sub_2" >{{payproSalset.confirmorList[3].paypcfOperatorcalDis}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operatatetime')}}：</span><span class="item_sub_2" >{{payproSalset.confirmorList[3].paypcfOptimecal}}</span></p>
                      </Col>
                    </Row>
                    <Row v-if="payproSalset.confirmorList.length >= 3 && payproSalset.confirmorList[2].paypcfRound === '90final'">
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operator')}}：</span><span class="item_sub_2" >{{payproSalset.confirmorList[2].paypcfOperatorcalDis}}</span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operatatetime')}}：</span><span class="item_sub_2" >{{payproSalset.confirmorList[2].paypcfOptimecal}}</span></p>
                      </Col>
                    </Row>
                  </div>
                </div>
              ...
              <div class="dataBlocks" v-for="(item, index) in dataBlocks" :key="index">
                ...
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1100')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=1)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline" href="javascript:void(0);" @click="btnAlertListModel('01round')" >{{$t('button.view')}}</a></span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline"  href="javascript:void(0);" @click="openCheckListModel('01round')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                ...
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1200')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=2)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline" href="javascript:void(0);" @click="btnAlertListModel('02round')" >{{$t('button.view')}}</a></span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline"  href="javascript:void(0);" @click="openCheckListModel('02round')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                ...
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1300')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=3)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline" href="javascript:void(0);" @click="btnAlertListModel('03round')" >{{$t('button.view')}}</a></span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline"  href="javascript:void(0);" @click="openCheckListModel('03round')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row>
                      <Col span="10" offset="1">
                ...
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1400')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=90)">
                  ...
                  <div class="dataContent">
                    ...
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payReport')}}：</span><span class="item_sub_2"><a style="text-decoration:underline" href="javascript:void(0);" @click="btnAlertListModel('90final')" >{{$t('button.view')}}</a></span></p>
                      </Col>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub"> {{$t('lang_communication.commonFlowUpdate2.errList')}}：</span><span class="item_sub_2"><a style="text-decoration:underline"  href="javascript:void(0);" @click="openCheckListModel('90final')">{{$t('button.view')}}</a></span></p>
                      </Col>
                    </Row>
                    <Row v-if="payproSalset.confirmorList.length == 4 ">
                      <Col span="10" offset="1" >
                    ...
                    <Row >
                      <Col span="22" offset="1">
                      <p  style="height:30px;line-height:30px;padding-left:150px;">{{$t('lang_communication.commonFlowUpdate2.paylink5')}}： <Checkbox v-model="paypcfIsconfirm" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update'))" @on-change="isSureChecked"> </Checkbox></p>
                      </Col>
                    </Row>
              ...
              <div class="dataBlocks" v-for="(item, index) in dataBlocks" :key="index">
                ...
                <div style="width:100%;" v-if="(item.flsdbMark.split('_')[1]=='1100')&&(parseInt(salaryComputationObj.payproRound.slice(0,2))>=1)">
                  ...
                  <div class="dataContent">
                    ...
                    <!-- <Row>
                        <Col span="10" offset="1">
                            <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.payproPlandate')}}：</span><span class="item_sub_2" v-if="salaryComputationObj.payproPlandate.indexOf('#')==-1">{{salaryComputationObj.payproPlandate.split('#')[0]}}</span></p>
                        </Col>

                    </Row> -->
                    <Row>
                      <Col span="10" offset="1">
                      <p class="item_3_1"><span class="item_sub">Bank Report({{$t('lang_communication.commonFlowUpdate2.cmpbank')}})</span><span class="item_sub_2">
                    ...
                    <Row>
                      ...
                      <FormItem :label="$t('lang_communication.commonFlowUpdate2.platDctpAffix')" prop="platDctpAffix">
                        <Row>
                          <i-col span="3">
                            <Upload :before-upload="handleUpload" action=" ">
                              <Button icon="ios-cloud-upload-outline" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update'))">浏览</Button>
                            </Upload>
                          </i-col>
                    ...
                    <Row>
                      <Col span="20" offset="1">
                      <FormItem :label="$t('lang_communication.commonFlowUpdate2.payproBankcomment')" prop="payproPeriod">
                        <Input v-model="payproBankcomment" type="textarea" :rows="4" :placeholder="$t('lang_communication.commonFlowUpdate2.payproBankcommentDis')" style="width:720px;" :disabled="!((!disabled)&&(item.flsdbOptauth=='02update'))"></Input>
                      </FormItem>
                      </Col>
                    ...
                    <!-- <Row>
                        <Col span="10" offset="1">
                            <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operator')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList.length>=1">{{payproOperatorbankDis}}</span></p>
                        </Col>
                        <Col span="10" offset="1">
                          <p class="item_3_1"><span class="item_sub">{{$t('lang_communication.commonFlowUpdate2.operatatetime')}}：</span><span class="item_sub_2" v-if="payproSalset.confirmorList.length>=1">{{payproOptimebankDis}}</span></p>
                        </Col>
                    </Row>     -->
                  </div>
                </div>
                ...
                <div class="">
                  <Form label-position="right" :label-width="200">
                    <Row>
                      ...
                      <Col span="10" offset="1">
                      <FormItem :label="$t('lang_communication.commonFlowUpdate2.updateTime')">
                        <Input :value="item.flsdbMark.opttime" disabled></Input>
                      </FormItem>
                      </Col>
                    </Row>
                  </Form>
                  <!-- <span style="margin-right: 10px;">{{$t('lang_communication.commonFlowUpdate2.operator')}}:</span>
          ...
          <div class="footer" v-show="thisStepState !== 'p_flowst_3' && thisStepState !== 'p_flowst_0'">
            <div class="footerChilden" v-show="stepAuthLimits == '03submit'">
              <Button type="primary" @click="save('ruleForm')" :loading="loading1"><span v-if="!loading1">{{$t('button.sav')}}</span></Button>
              <Button type="success" style="margin-left: 5px;" @click="isSubmit('ruleForm')" :loading="loading2" v-show="thisPkValue !== '0'">{{$t('button.subm')}}</Button>
            </div>
          </div>
        </Form>
      </div>
...
<script>
  ...
  import PayproSalset from './flowPayproSalsetList'
  import salaryComputation from './flowPaySalaryComputation'
  import flowPayErrorList from './flowPayErrorList'
  import flowPaySureErrorList from './flowPaySureErrorList'
  import { getDataLevelUserLogin, getDataLevelUserLoginNew2, getDataLevelUserLoginNew3, uploadFile } from '../../../axios/axios'
  ...
  export default {
    data() {
      return {
        ...
        rules: {
          name: [
            { required: true, message: this.$t('lang_communication.commonFlowUpdate2.payRemind'), trigger: 'change' },
          ],
        },
        logType: "保存",
        ruleValidate: {}
...
//            this.$store.state.app.pageOpenedList = JSON.parse(localStorage.pageOpenedListAll)
          ...
          if (isSuccess(res, t)) {
            if(res.data.content[0].filename!='no record'){
              ...
              t.$Modal.success({
                ...
                content: this.$t('reminder.genersuccess'),
              })
            } else {
              t.$Modal.error({
                title: this.$t('reminder.err'),
                content: this.$t('reminder.generfailed'),
              })
            }
            ...
            if (isSuccess(res, t)) {
              ...
              if(res.data.content[0].value>0){
                ...
                t.$Modal.error({
                  ...
                  content: t.$t('lang_communication.commonFlowUpdate2.advanceHandle'),
                })
          ...
          .then(res => {
            if (isSuccess(res, t)) {
              if(res.data.content[0].value!='0'){
                ...
                t.$Modal.success({
                  title: this.$t('reminder.remind'),
                  content: this.$t('reminder.noErrData'),
                });
              }
            }
          })
      ...
      btnAlertModel() {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'PaySalSet.getById",
          funId: t.funId, //
          logType: "查看", // 主键值
      ...
      getPayproSalset() {
        ...
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'PayFlowPayrollprocess.getByIdAndStep",
          funId: t.funId, //
            ...
            if (isSuccess(res, t)) {
              ...
              if (res.data.content.length > 0) {
                ...
                if(t.openIdUpdate=='4-1'||t.openIdUpdate=='4-2'||t.openIdUpdate=='4-3'){
                  t.payproSalset.confirmorList = userInfo.confirmorList;
                  console.log(t.payproSalset.confirmorList, '11111111111111')
                  console.log(t.payproSalset.confirmorList.length, '11111111111111')
                  22
                }
      ...
      getData() {
        const t = this;
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'PlatAutoLayoutGetFlowList.getPage",
          sort: "id",
          order: "desc",
          rows: "1",
          page: "1",
        ...
        getDataLevelUserLogin(params)
          .then(res => {
            if (isSuccess(res, t)) {
              ...
              console.log(t.dataBlocks, 't.dataBlockst.dataBlockst.dataBlockst.dataBlocks')
      ...
      isSubmit(formName) {
        ...
        if((this.openIdUpdate == "4-1"||this.openIdUpdate == "4-2"||this.openIdUpdate == "4-3" )&&this.salaryComputationObj.payproRound.slice(0,2)==90){
          if(t.paypcfIsconfirm==false){
            t.$Modal.error({
              title: this.$t('reminder.remind'),
              content: this.$t('lang_communication.commonFlowUpdate2.advaceSelect')
            });
            return
          }
        }
              ...
              .then(res => {
                ...
                if (isSuccess(res, t)) {
                  if (t.thisPkValue === "0") {
                    ...
                    console.log(res.data.content[0].value);
                    console.log(t.thisStepId + this.$t('button.sav'));
