                    ...
                    <div class="footer"
                        ...
                        <div class="footerChilden">
                            ...
                            <Button type="primary"
                                    :loading="loading1"
                                    @click="sendSign"
                                    v-show="qysBtn&&thisPkValue !== '0'"><span v-show="!loading1">{{stepCode == "flow_prove_1000" ? '发送公司盖章' : '发送电子签'}}</span></Button>
                            <Button type="success"
...
import childTable from '../flowChildTable/childTable'
import sumTable from '../flowSumTable/sumTable'
...
export default {
    ...
    methods: {
        ...
        emptyVx () {
            const t = this;
            t.$store.commit('flowList/setOriginIncome', '');
            t.$store.commit('flowList/setThreeGears', '');
            t.$store.commit('flowList/setFixedIncome', '');
        },
        sendSign () {
            const t = this
            getDataLevelUserLoginData({
