const apply_canceltravel = {
  all_dis() {
    apply_canceltravel.apptrMamconfirm_dis(this)
  },
  apptrMamconfirm(node) {
    apply_canceltravel.apptrMamconfirm_set(this.$parent)
    apply_canceltravel.apptrMamconfirm_dis(this.$parent)
  },
...
export default apply_canceltravel
