          ...
          <row class="table-form" ref="table-form">
            ...
            <Table :columns="columns" :data="data">
              <template slot-scope="{ row, index }" slot="name">
                <Input type="text" v-model="name" v-if="editIndex === index" disabled/>
              ...
              <template slot-scope="{ row, index }" slot="action">
                <div v-if="editIndex === index">
                  ...
                  <!--<Button @click="editIndex">取消</Button>-->
                </div>
                <div v-else>
                  <Button @click="handleEdit(row, index)" :disabled="!btnRole">修改</Button>
                </div>
              </template>
            </Table>
...
//          res.data.content[0].rows[0] = []
          let len = (res.data.content[0].rows[0].length === 0)
//          if (len) {
//            return false
//          }
