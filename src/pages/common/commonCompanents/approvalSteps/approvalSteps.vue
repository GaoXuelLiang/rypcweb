...
<script>
  ...
  export default{
    ...
    mounted() {
      const t = this
//      console.log(520, t.flowInfo)
//      console.log(521, t.chlcolumns)
//      t.chlcolumns.push(t.revise)
    ...
    methods: {
      ...
      getData(page, value) {
        const t = this
//        console.log(1111222233334444455555, t.flowInfo)
        if (page) {
          t.page = page
        }
        const data = {
          _mt:  this.$global.mt+'PlatAprvrecord.getListByOneBill',
          rows: t.rows,
          page: t.page,
          sort: t.sort,
          order: t.order,
          logType: '查询一个单据的所有审批记录信息',
          apblDataid: t.flowInfo.pkValue,
          apblFlowid: t.flowInfo.flowId,
          apblStepid: t.flowInfo.stepId,
        }
          ...
          t.$Modal.confirm({
            ...
            onOk: () => {
              getDataLevelUserLogin({
                _mt:  this.$global.mt+'EmpNewhireEducation.delByIds',
                funId: '1',
