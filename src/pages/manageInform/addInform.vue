    ...
    <div class="box">
      ...
      <Row style="margin-top:20px;">
        ...
        <Row type="flex" justify="end">
          <Button @click="handleReset" v-show="!editdisabled" style="margin-right: 8px">{{$t('button.cal')}}</Button>
  ...
  export default {
    data() {
      return {
        ...
        CmutNoticeStatelist: [],
        form: {
          _mt:  this.$global.mt+'CmutNotic.addOrUpd',
          logType: '新增',
    ...
    methods: {
      ...
      upData(id) {
        const t = this
        getDataLevelUserLogin({
          _mt:  this.$global.mt+'CmutNotic.getById',
          id: id,
          logType: '修改',
        }).then((res) => {
          if (isSuccess(res, t)) {
