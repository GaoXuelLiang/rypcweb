<template>
  <Row style="max-height: 400px;overflow-y: scroll;">
    ...
    <Row class="sing"  v-for="(item, index) in empUserInfoAllList" :key="index">
      ...
      <Row>
        <i-col span="6" class="col1">账号类型：</i-col>
        <i-col span="6" class="col2">{{item.empbkTypeDis}}</i-col>

        <i-col span="6" class="col1">银行：</i-col>
        <i-col span="6" class="col2">{{item.empbkBasebankDis}}</i-col>
      </Row>

      <Row>
        <i-col span="6" class="col1">开户银行：</i-col>
        <i-col span="6" class="col2">{{item.empbkBank}}</i-col>

        <i-col span="6" class="col1">账号：</i-col>
        <i-col span="6" class="col2">{{item.empbkAccount}}</i-col>
      </Row>

      <Row>
        <i-col span="6" class="col1">户名：</i-col>
        <i-col span="6" class="col2">{{item.empbkAccnane}}</i-col>
      </Row>

      <Row>
        <i-col span="6" class="col1">生效日期：</i-col>
        <i-col span="6" class="col2">{{item.empbkSdate}}</i-col>

        <i-col span="6" class="col1">失效日期：</i-col>
        <i-col span="6" class="col2">{{item.empbkEdate}}</i-col>
      </Row>
    </Row>
...
<script>
  import update from '../update/update6'
