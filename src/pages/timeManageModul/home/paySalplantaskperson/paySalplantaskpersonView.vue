        ...
        <div class="box">
            ...
            <Form ref="formValidate"
                ...
                <Row>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_payroll.paySalplan.salpltkpEmployeeDis')"
                              prop="salpltkpEmployeeDis">
                        <span @dblclick="clearCityid">
                            <Input v-model="formValidate.salpltkpEmployeeDis"
                                   icon="ios-search"
                                   :readonly="true"
                                   :placeholder="$t('lang_payroll.paySalplan.salpltkpEmployeeDisCheck')"
                                   @on-click="pickData" />
                        </span>
                    </FormItem>
                    </Col>
                    <Col span="10"
                         offset="1">
                    <FormItem :label="$t('lang_payroll.paySalplan.salpltkpIsmain')"
                              prop="salpltkpIsmain">
                        <RadioGroup v-model="formValidate.salpltkpIsmain" type="button" size="small"
                                    :placeholder="$t('lang_payroll.paySalplan.salpltkpIsmainCheck')">
                ...
                <Row>
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_payroll.paySalplan.salpltkpResdesc')"
                              prop="salpltkpResdesc">
                        <Input v-model="formValidate.salpltkpResdesc"
                               :placeholder="$t('lang_payroll.paySalplan.salpltkpResdescCheck')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <FormItem :label="$t('lang_payroll.paySalplan.salpltkpEmpstatusDis')">
                        <Input disabled
                               v-model="formValidate.salpltkpEmpstatusDis"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="21"
                         offset="1">
                    <FormItem :label="$t('lang_payroll.paySalplan.salpltkpComment')"
                              prop="salpltkpComment">
                        <Input v-model="formValidate.salpltkpComment"
                               type="textarea"
                               :autosize="{minRows: 2,maxRows: 5}"
                               :placeholder="$t('lang_payroll.paySalplan.salpltkpCommentCheck')"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
    ...
    methods: {
        ...
        getData (id) {
            ...
            getDataLevelUserLogin({
                _mt:  this.$global.mt+'PaySalplantaskperson.getById',
                id: id,
                logType: '根据id获取数据',
            }).then((res) => {
                if (isSuccess(res, t)) {
        ...
        handleSubmit () {
            ...
            params._mt =  this.$global.mt+'PaySalplantaskperson.addOrUpd'
