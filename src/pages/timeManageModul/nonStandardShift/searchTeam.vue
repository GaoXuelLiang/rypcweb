    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          ...
          <Icon type="ios-bookmark" size="16"></Icon> 选择班组
        </div>
      ...
      <Row class="table-form">
        <Input placeholder="班组名称" style="width: 200px" v-model="attShifName"/>
...
export default{
  data() {
    return {
      ...
      attShifName: '',
      params: {
        _mt:  this.$global.mt+'AttendTeam.getByObjectTeam',
        sort: 'id',
        order: 'desc',
        rows: 10,
        page: 1,
  ...
  methods: {
    getData(page) {
      ...
      data.attTeamName = t.attShifName?t.attShifName:''
      data.attTeamHircompany = t.comId
