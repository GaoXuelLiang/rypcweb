<template>
  <div class="cover">
        ...
        <Row>
          ...
          <FormItem :label="$t('lang_payroll.paySalplan.salpltkpEmployeeDis')" prop="salpltkpEmployeeDis">
            <span @dblclick="clearCityid">
              <Input v-model="formValidate.salpltkpEmployeeDis"  icon="ios-search" :readonly="true" :placeholder="$t('lang_payroll.paySalplan.salpltkpEmployeeDisCheck')"  @on-click="pickData" />
            </span>
          </FormItem>
          </Col>
          <Col span="10" offset="1">
          <FormItem :label="$t('lang_payroll.paySalplan.salpltkpIsmain')" prop="salpltkpIsmain">
            <RadioGroup v-model="formValidate.salpltkpIsmain" type="button" size="small" :placeholder="$t('lang_payroll.paySalplan.salpltkpIsmainCheck')">
    ...
    <transition name="fade">
      <searchCity v-show="openPick" :searchCloumns="searchCloumns" @closeUp="close" @changeinput="changeinput" ref="searchCity"></searchCity>
    </transition>
  </div>
</template>
<script>
