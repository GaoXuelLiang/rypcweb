    ...
    <div class="background">
        <div class="backbox">
            <div class="title">
                <div class="title-text">
                    <Icon type="ios-bookmark"
                          size="16"></Icon>&nbsp;{{$t('lang_knowBase.knowlegeType.selectPic')}}
                </div>
                <Button type="text"
                        @click="close">
                    <Icon type="md-close"
            ...
            <row class="table-form"
                 ref="table-form">
                <div class="item_icon"
                     v-for="(item, index) in indexFunImg"
                     :key="index"
                     @dblclick="getImgId(item)">
                    <div class="div"
                         :style="'background-image: url(../../../static/indexImg/'+ item +')'"></div>
                </div>
            </row>
        </div>
    </div>
