    ...
    <Row>
      ...
      <card>
        ...
        <Row>
          ...
          <span style="margin: 0;"><Button type="primary" >搜索</Button></span>
          <Button type="primary" @click="open">新增</Button>
          <Button type="error" >删除</Button>
        </Row>
        <row class="table-form">
          <Table height="500" size="small" border ref="selection" :columns="columns4" :data="data1"></Table>
        </row>
        <Row style="display: flex">          <Page :total="40" size="small" show-elevator show-sizer:page-size-opts = "[10, 20, 50, 100]" ></Page>
