...
<script>
import autoChildTable from '@/components/autoCommonPage/autoSpecileTable/autoChildTablePaySelectEmp'
...
export default {
    ...
    mounted () {
      console.log(this,this.selectionAlldata,"新页面1111")
       this.getChildId()
    },
    methods:{
        close(){
            const t = this
            t.$emit('closePaySelectEmp')
        ...
        getChildId () {
            ...
            getDataLevelUserLoginData({
                ...
                if (isSuccess(res, t)) {
                    ...
                    t.$store.commit('setChildFunId',  t.childFun[2].id)
