<template>
    <div class="cover">
                    ...
                    <Form ref="formValidate"
                        ...
                        <i-col span="10"
                            ...
                            <FormItem label="是否本公司基准岗"
                                      prop="apstIscompbch"
                                      v-if="formValidate.apstApprovetype === '03bybchpost'">
                                <RadioGroup v-model="apstIscompbch"
                                            type="button"
                                            size="small">
                        ...
                        <i-col span="10"
                            ...
                            <FormItem label="指定职类"
                                      prop="apstSpczhil"
                                      v-if="(formValidate.apstPostrang === '07posi'||formValidate.apstPostrang === '06unitbusi' )&& formValidate.apstApprovetype === '02bypost'">
                                <span @dblclick="clearDatazhil">
                                    <Input v-model="apstSpczhilDis"
                                           icon="ios-search"
                                           :readonly="true"
                                           placeholder="请选择指定职类"
                                           @on-click="selectzhil" />
                        ...
                        <i-col span="10"
                               offset="1">
                            <FormItem label="指定平台"
                                      v-if="formValidate.apstPostrang === '07platform'"
                                      prop="apstPostrang">
                                <Select v-model="formValidate.apstPlatform">
                                    <Option :value="item.paramCode"
                        ...
                        <i-col span="10"
                            ...
                            <FormItem label="是否异动"
                                      prop="apstIsturn">
                                <RadioGroup v-model="formValidate.apstIsturn"
                                            type="button"
                                            size="small">
                                    <Radio v-for="(item, index) in approveYesNo"
                                           :key="index"
                                           :label="item.paramCode">{{item.paramInfoCn}}</Radio>
                                </RadioGroup>
                            </FormItem>
                        </i-col>
                        <i-col span="21"
        ...
        <!-- 指定职类 -->
        <transition name="fade">
            <searchZhil v-show="openzhil"
                        @closeUp="closezhil"
                        :searchTitle='searchTitle'
                        @changeinputZhil="changeinputZhil"
                        ref="searchZhil"></searchZhil>
        </transition>
    </div>
</template>
<script>
...
import searchZhil from './searchZhil'
export default {
    data () {
        return {
            typeName: '',
    ...
    methods: {
        ...
        changeinputZhil (name, id) {
            const t = this
            t.apstSpczhilDis = name
            t.formValidate.apstSpczhil = id
        },
        ...
        * */
        getdata () {
            ...
            getDataLevelUserLoginData(data).then((res) => {
                if (isSuccess(res, t)) {
                    ...
                    t.formValidate.apstIsturn = res.data.content[0].apstIsturn ? res.data.content[0].apstIsturn : '0'
                    // 指定平台
                    t.formValidate.apstPlatform = res.data.content[0].apstPlatform
                    // 指定职等
                    t.apstSpczhilDis = res.data.content[0].apstSpczhilDis
                    t.formValidate.apstSpczhil = res.data.content[0].apstSpczhil
                }
            }).catch(() => {
                t.$Modal.error({
        ...
        getSelect () {
            ...
            getDataLevelUserLoginData({
                ...
                APtypeCode: 'approvetype,approvelevel,approvemode,yesno,postType,postrang,bussector',
            }).then((res) => {
                if (isSuccess(res, t)) {
                    ...
                    t.platformOptions = res.data.content[0].value[6].paramList
                }
            }).catch(() => {
                this.$Modal.error({
                    title: this.$t('reminder.err'),
        ...
        * */
        ...
        clear () {
            ...
            this.formValidate.apstIsturn = '0'
