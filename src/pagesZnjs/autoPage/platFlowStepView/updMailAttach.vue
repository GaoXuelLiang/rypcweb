        ...
        <Form ref="formValidate" disabled :model="formValidate" :rules="ruleValidate" label-position="right" :label-width="135">
          ...
          <i-col span="10" offset="1" v-show=" typeValue === '01fixed' ">
            <FormItem :label="$t('lang_flow.mailAttach.flsmlatAttach')"  prop="flsmlatAttach">
              <span @dblclick="dbclear">
                <Input v-model="flsmlatAttachDis"   :placeholder="$t('lang_flow.mailAttach.p_flsmlatAttach')" @on-click="pickData"/>
            </span>
            </FormItem>
          </i-col>
          <i-col span="10" offset="1" v-show=" typeValue === '03flowgen' ">
            <FormItem :label="$t('lang_flow.mailAttach.flsmlatGendocid')" prop="flsmlatGendocid">
              <span @dblclick="dbclear">
                <Input v-model="flsmlatGendocidDis"   :placeholder="$t('lang_flow.mailAttach.p_flsmlatGendocid')" @on-click="pickData"/>
            </span>
            </FormItem>
          </i-col>
