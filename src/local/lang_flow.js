export default {
    'zh-CN': {
        ...
        step: {
            ...
            p_flstepCnName: '请输入步骤中文名',
            p_flstepEnName: '请输入步骤英文名',
            ...
            rule_flstepCnName: '步骤中文名不能为空',
            rule_flstepEnName: '步骤英文名不能为空',
        ...
        dataBlock: {
            ...
            p_flsdbCode: '请输入数据块编码',
            p_flsdbCnName: '请输入数据块名称',
            p_flsdbEnName: '请输入数据块英文名称',
        ...
        docTemplate: {
            ...
            flsdcIspdf: '是否PDF',
            comment: '备注',
            flsdcCuslkstr: '公司盖章检索',
            flsdcPoplkstr: '个人签字检索',
            ...
            p_comment: '请输入备注',
            p_flsdcCuslkstr: '请输入公司盖章检索',
            p_flsdcPoplkstr: '请输入个人签字检索',
        ...
        mail: {
            ...
            rule_flsmlReciever: '接收人不能为空',
            rule_flsmlCC: '抄送人不能为空',
    ...
    'en-US': {
        ...
        dataBlock: {
            ...
            p_flsdbCode: 'Please select the code',
        ...
        docTemplate: {
            ...
            flsdcIspdf: 'Is PDF',
            comment: 'Comment',
            flsdcCuslkstr: 'Company Seal search',
            flsdcPoplkstr: 'Personal signature search',
            ...
            p_comment: 'Please input comment',
            p_flsdcCuslkstr: 'Please input Company Seal search',
            p_flsdcPoplkstr: 'Please input Personal signature search',
        ...
        mail: {
            ...
            p_flsmlReciever: 'Please enter the recipient',
            p_flsmlCC: 'Please enter cc',
            ...
            rule_flsmlReciever: 'The receiver cannot be empty',
            rule_flsmlCC: 'Cc cannot be empty',
