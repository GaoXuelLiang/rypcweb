    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;选择上级岗位
        </div>
      ...
      <Row class="table-form">
        <Input placeholder='选择上级岗位' style="width: 200px" v-model="postFnameCnDis"/>
  ...
  export default{
    ...
    methods: {
      getData(params, page) {
        ...
        data.postFnameCnDis = t.postFnameCnDis
        data.id = t.postNo
