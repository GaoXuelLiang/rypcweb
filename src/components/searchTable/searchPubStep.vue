    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          ...
          {{$t('lang_platdoc.platMail.searchTitle')}}
        </div>
...
export default{
  data() {
    return {
      ...
      searchText: this.$t('lang_platdoc.platMail.flowNameDis'),
      params: {
      ...
      searchCloumns: [
        {
          title: this.$t('lang_platdoc.platMail.flowName'),
          key: 'flowName',
          sortable: 'custom',
          width: 250,
        },
