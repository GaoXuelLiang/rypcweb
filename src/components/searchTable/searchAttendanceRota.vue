    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          ...
          <Icon type="ios-bookmark" size="16"></Icon> 选择班次
        </div>
      ...
      <Row class="table-form">
        <Input placeholder="班次名称" style="width: 200px" v-model="attShifName"/>
...
export default{
  ...
  methods: {
    getData(page) {
      ...
      data.attShifName = t.attShifName
      data.attShifHircompany = t.comId
