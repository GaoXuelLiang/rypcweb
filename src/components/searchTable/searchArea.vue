    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          ...
          &nbsp;{{$t('lang_search.benefitArea.title')}}
        </div>
...
export default{
  data() {
    return {
      ...
      total: NaN,
      pmtypeCode: '',
      searchText: this.$t('lang_search.benefitArea.bfareaCnamePrompt'),
      params: {
      ...
      searchCloumns: [
        {
          title: this.$t('lang_search.benefitArea.bfareaCode'),
          key: 'bfareaCode',
          sortable: 'custom',
          width: 379,
        },
        {
          title: this.$t('lang_search.benefitArea.bfareaCname'),
          key: 'bfareaCname',
          sortable: 'custom',
          width: 380,
        },
        {
          title: this.$t('lang_search.benefitArea.bfareaEname'),
          key: 'bfareaEname',
          sortable: 'custom',
          width: 380,
        },
  ...
  methods: {
    getData() {
      ...
      getDataLevelUserLoginNew(data).then((res) => {
        ...
        t.$Modal.error({
          title: $t('reminder.err'),
          content: $t('reminder.errormessage'),
        })
      })
    },
    close() {
