    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;{{$t('lang_platform.PlatFyperiod.selectTitle')}}
        </div>
...
export default{
  data() {
    return {
      ...
      total: NaN,
      fypdYear: '',
      searchText: this.$t('lang_platform.platFiscalyear.fyYearDis'),
      params: {
        _mt:  this.$global.mt+'PlatFyperiod.getPageNew',
        sort: 'id',
        order: 'asc',
        rows: 10,
        page: 1,
