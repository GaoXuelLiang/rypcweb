  ...
  <div class="background">
    <div class="backbox">
      ...
      <Row class="table-form">
        <Input placeholder="请输入指标名称" style="width: 200px" v-model="normName"/>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      dbCkick(row) {
        const t = this
        this.$emit('changeinput', row[t.searchCloumns[1].key], row.id, row[t.searchCloumns[0].key])
        t.close()
      },
      sizeChange(size) {
        const t = this
