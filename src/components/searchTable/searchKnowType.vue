    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;{{searchTitle ? searchTitle : title}}
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="$t('lang_communication.workorderSearch.searchText')" style="width: 200px" v-model="cmutKntypeCode"/>
...
<script>
  ...
  export default{
    data() {
      return {
        title: this.$t('lang_communication.workorderSearch.defaTitle'),
        data: [],
        total: NaN,
        current: 1,
        cmutKntypeCode: '',
    ...
    methods: {
      getData(params, page) {
        ...
        data.cmutKntypeCode = t.cmutKntypeCode
        data.cmutKntypeBusprop = t.cmutKntypeBusprop
