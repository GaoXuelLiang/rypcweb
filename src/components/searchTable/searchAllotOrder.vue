    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;{{$t('lang_communication.allotWorkOrder.searchTitle')}}
        </div>
      ...
      <Row class="table-form">
        ...
        <Button type="primary"  @click="searchData">{{$t('button.ser')}}</Button>
  ...
  export default{
    ...
    methods: {
      getData(row) {
        ...
        t.tId = row
        const dataP = {
        	_mt:  this.$global.mt+'CmutSupteammember.getPage',
...
//      console.log(row)
        const data = {
        	_mt:  this.$global.mt+'CmutWorkorderrecord.addOrUpd',
        	logType: '分配工单',
        	cmwdrdWdid: t.tId.id,
