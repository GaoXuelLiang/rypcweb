    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon>&nbsp;{{searchtTitle}}
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="searchText" style="width: 200px" v-model="cmstmCode"/>
        <span style="margin: 0;"><Button type="primary"  @click="getData(params)">{{$t('button.ser')}}</Button></span>
      </Row>
  ...
  export default{
    ...
    methods: {
      getData(params) {
        ...
        data.cmstmCode = t.cmstmCode
        data.cmstmStid = t.cmstmStid
