    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          ...
          {{$t('lang_platdoc.platMail.searchTitle2')}}
        </div>
...
export default{
  data() {
    return {
      ...
      searchText: this.$t('lang_platdoc.platMail.flstepNameDis'),
      params: {
      ...
      searchCloumns: [
        {
          title: this.$t('lang_platdoc.platMail.flstepName'),
          key: 'flstepName',
          sortable: 'custom',
          width: 250,
        },
...
//    this.getData(1)
  ...
  methods: {
    getData(page) {
      ...
      t.loading = true;
      t.isSpin = true;
      this.params.flstepFlow = this.flstepFlowCop
