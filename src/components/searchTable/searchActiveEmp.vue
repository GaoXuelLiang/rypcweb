    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="ios-bookmark" size="16"></Icon><!--{{$t('lang_search.activeEmp.title')}}-->&nbsp;选择员工
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="$t('lang_search.activeEmp.empCnameDis')" style="width: 200px" v-model="empCname"/>
        <span style="margin: 0;"><Button type="primary" style="width:56px"  @click="getData(1)">{{$t('button.ser')}}</Button></span>
      </Row>
  ...
  export default{
    data() {
      return {
        ...
        searchCloumns: [
          {
            title: this.$t('lang_search.activeEmp.empCname'),
            key: 'empCname',
            sortable: 'custom',
          },
          {
            title: this.$t('lang_search.activeEmp.empctaPersmail'),
            key: 'empctaPersmail',
            sortable: 'custom',
          },
        ],
