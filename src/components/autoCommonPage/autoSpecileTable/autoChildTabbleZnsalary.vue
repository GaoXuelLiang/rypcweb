...
export default {
    ...
    methods: {
        ...
        expData (value) {
            ...
            if (t.childMainId && t.childMainId !== '') {
                data['PI0004'] = t.childMainId
            } else {
        ...
        paysRollProject (id, paycphCompanyId) {
            const t = this
            if (id) {
                t.accountid = id
            }
            if (paycphCompanyId) {
                t.paycphCompanyId = paycphCompanyId
            }
            t.initChildData()
            t.data = []
            t.isSpin = true
        ...
        getData (value, value1) {
            ...
            // data.salaSalproid = t.accountid
            data.plsUnitid = t.paycphCompanyId
            getDataLevelUserLoginData(data).then((res) => {
                if (isSuccess(res, t)) {
